...
func TestParse_Enum(t *testing.T) {
	testcases := []struct {
		...
		},
		{
			...
			d:    "z",
			test: func(t *testing.T, v interface{}, err error) {
				require.EqualError(t, err, "found 1 error:\nvalue 'z' does not match one in the enumeration [a, b, c]\nschema path #/enum")
			},
		},
		{
		...
		},
		{
			...
			d:    9,
			test: func(t *testing.T, v interface{}, err error) {
				require.EqualError(t, err, "found 1 error:\nvalue '9' does not match one in the enumeration [1, 2, 3]\nschema path #/enum")
			},
		},
		{
		...
		},
		{
			...
			d:    1.5,
			test: func(t *testing.T, v interface{}, err error) {
				require.EqualError(t, err, "found 1 error:\nvalue '1.5' does not match one in the enumeration [1.1, 2.2, 3.3]\nschema path #/enum")
			},
		},
		{
		...
		},
		{
			...
			test: func(t *testing.T, v interface{}, err error) {
				require.EqualError(t, err, "found 1 error:\nvalue '{foo: qux}' does not match one in the enumeration [{foo: bar}, {foo: baz}]\nschema path #/enum")
			},
		},
		{
