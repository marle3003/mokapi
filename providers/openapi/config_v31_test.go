...
func TestConfig_v31(t *testing.T) {
	...
	petDetails := readJsonTestFile(t, "./test/petdetails.json", &schema.Schema{}, "https://petstore31.swagger.io/api/v31/components/schemas/petdetails")
	reader.Data[petDetails.Info.Url.String()] = petDetails
	category := readJsonTestFile(t, "./test/category.json", &schema.Schema{}, "https://petstore31.swagger.io/api/v31/components/schemas/category")
	reader.Data[category.Info.Url.String()] = category
	tag := readJsonTestFile(t, "./test/tag.json", &schema.Schema{}, "https://petstore31.swagger.io/api/v31/components/schemas/tag")
