...
func validateString(i interface{}, s *openapi.Schema) error {
	v := reflect.ValueOf(i)
...
func validateFloat64(n float64, schema *openapi.Schema) error {
...
func validateInt64(n int64, schema *openapi.Schema) error {
	if schema.Minimum != nil {
