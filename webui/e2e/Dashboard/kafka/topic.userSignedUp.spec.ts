...
import { useKafkaGroups, useKafkaMessages, useKafkaOverview, useKafkaPartitions } from '../../components/kafka'
...
test.describe('Visit Kafka', () => {
    test('Visit topic mokapi.shop.userSignedUp', async ({ page, context }) => {
        ...
        await test.step('Check groups"', async () => {
            ...
            await group.testGroup(1, cluster.groups[1])
        })
