...
const downloadUrl = computed(() => {
    const base = `/api/services/websocket/${encodedName.value}`
    return transformPath(`${base}/asyncapi.${selectedFormat.value}`)
})
...
<template>
    <div class="modal fade" id="export-asyncapi" tabindex="-1" ref="modalEl" aria-hidden="true" aria-labelledby="export-asyncapi-title">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="export-asyncapi-title">Export AsyncAPI Specification</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div v-if="!isLiveMode" class="alert alert-primary py-2 px-3 mb-3 small" role="alert">
                        This is a demo dashboard — AsyncAPI exports aren't available here.
