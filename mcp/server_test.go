...
func TestServer(t *testing.T) {
	...
	// alphabetical order
	require.Equal(t, "generate_http_response", list.Tools[0].Name)
	...
	require.Equal(t, "get_http_response_schema", list.Tools[4].Name)
	require.Equal(t, "get_mokapi_js_api", list.Tools[5].Name)
	require.Equal(t, "produce_kafka_message", list.Tools[6].Name)
	require.Equal(t, "send_http_request", list.Tools[7].Name)
}
