...
`,
			fn: func(t *testing.T, r *Ref) {
				require.Equal(t, 12, r.Value.Example)
			},
		},
		{
			name: "example array",
...
`,
			fn: func(t *testing.T, r *Ref) {
				require.Equal(t, []interface{}{1, 2, 3}, r.Value.Example)
			},
		},
		{
			name: "example object",
...
`,
			fn: func(t *testing.T, r *Ref) {
				require.Equal(t, map[string]interface{}{"id": 1, "name": "Jessica Smith"}, r.Value.Example)
			},
		},
		{
			name: "enum value",
...
`,
			fn: func(t *testing.T, r *Ref) {
				require.Equal(t, []interface{}{12}, r.Value.Enum)
			},
		},
		{
			name: "enum array",
