...
Received string:  "{  \"category\": \"Games\",  \"description\": \"Automate woman recovery clearly.\",  \"id\": \"e5d269f8-de04-414a-a9bb-590495c2eb61\",  \"keywords\": \"\",  \"url\": \"https://www.deputybenchmark.biz/24-7/back-end\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Games",  "description": "Automate woman recovery clearly.",  "id": "e5d269f8-de04-414a-a9bb-590495c2eb61",  "keywords": "",  "url": "https://www.deputybenchmark.biz/24-7/back-end"}"

```

```yaml
- text: "{ \"category\": \"Games\", \"description\": \"Automate woman recovery clearly.\", \"id\": \"e5d269f8-de04-414a-a9bb-590495c2eb61\", \"keywords\": \"\", \"url\": \"https://www.deputybenchmark.biz/24-7/back-end\" }"
```
