...
Received string:  "{  \"description\": \"Archive stale government responsibly.\",  \"id\": \"59f582f9-5a08-40d0-ac7a-1a6356fea00e\",  \"keywords\": \"EuZDrebzFO\",  \"name\": \"Evolve\",  \"subcategory\": \"Cwfg\",  \"url\": \"https://www.dynamictechnologies.io/integrate\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "description": "Archive stale government responsibly.",  "id": "59f582f9-5a08-40d0-ac7a-1a6356fea00e",  "keywords": "EuZDrebzFO",  "name": "Evolve",  "subcategory": "Cwfg",  "url": "https://www.dynamictechnologies.io/integrate"}"

```

```yaml
- text: "{ \"description\": \"Archive stale government responsibly.\", \"id\": \"59f582f9-5a08-40d0-ac7a-1a6356fea00e\", \"keywords\": \"EuZDrebzFO\", \"name\": \"Evolve\", \"subcategory\": \"Cwfg\", \"url\": \"https://www.dynamictechnologies.io/integrate\" }"
```
