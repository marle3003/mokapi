...
Received string:  "{  \"description\": \"Map the happy path through government.\",  \"id\": \"27e8b04a-5562-490a-8656-2db076a6f9cf\",  \"keywords\": \"ulhrWvLzHJKrGw\",  \"name\": \"Zenix\",  \"price\": 772722.18,  \"subcategory\": \"wJVoSqw4dk4R6l \",  \"url\": \"http://www.legacytransform.info/out-of-the-box/cultivate/web-enabled/plug-and-play\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "description": "Map the happy path through government.",  "id": "27e8b04a-5562-490a-8656-2db076a6f9cf",  "keywords": "ulhrWvLzHJKrGw",  "name": "Zenix",  "price": 772722.18,  "subcategory": "wJVoSqw4dk4R6l ",  "url": "http://www.legacytransform.info/out-of-the-box/cultivate/web-enabled/plug-and-play"}"

```

```yaml
- text: "{ \"description\": \"Map the happy path through government.\", \"id\": \"27e8b04a-5562-490a-8656-2db076a6f9cf\", \"keywords\": \"ulhrWvLzHJKrGw\", \"name\": \"Zenix\", \"price\": 772722.18, \"subcategory\": \"wJVoSqw4dk4R6l \", \"url\": \"http://www.legacytransform.info/out-of-the-box/cultivate/web-enabled/plug-and-play\" }"
```
