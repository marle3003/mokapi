...
Received string:  "{  \"category\": \"Travelogue\",  \"description\": \"Oops! Ship the person now!\",  \"id\": \"1eaa65a7-eccd-43ac-9fca-0885df256230\",  \"keywords\": \"wqnlQRUduxxEtIh\",  \"subcategory\": \"GLrLCOeqWvd\",  \"url\": \"https://www.publicexperiences.name/streamline/enhance/target/networks\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Travelogue",  "description": "Oops! Ship the person now!",  "id": "1eaa65a7-eccd-43ac-9fca-0885df256230",  "keywords": "wqnlQRUduxxEtIh",  "subcategory": "GLrLCOeqWvd",  "url": "https://www.publicexperiences.name/streamline/enhance/target/networks"}"

```

```yaml
- text: "{ \"category\": \"Travelogue\", \"description\": \"Oops! Ship the person now!\", \"id\": \"1eaa65a7-eccd-43ac-9fca-0885df256230\", \"keywords\": \"wqnlQRUduxxEtIh\", \"subcategory\": \"GLrLCOeqWvd\", \"url\": \"https://www.publicexperiences.name/streamline/enhance/target/networks\" }"
```
