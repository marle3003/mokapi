...
Received string:  "{  \"category\": \"Biography\",  \"description\": \"Warm starts beat cold government.\",  \"id\": \"6956c9b6-d795-473f-b817-f8b9c8e19952\",  \"name\": \"Velvet\",  \"price\": 931541.96,  \"subcategory\": \"nTOvnhogd2\",  \"url\": \"https://www.mainunleash.name/ubiquitous/one-to-one/partnerships\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Biography",  "description": "Warm starts beat cold government.",  "id": "6956c9b6-d795-473f-b817-f8b9c8e19952",  "name": "Velvet",  "price": 931541.96,  "subcategory": "nTOvnhogd2",  "url": "https://www.mainunleash.name/ubiquitous/one-to-one/partnerships"}"

```

```yaml
- text: "{ \"category\": \"Biography\", \"description\": \"Warm starts beat cold government.\", \"id\": \"6956c9b6-d795-473f-b817-f8b9c8e19952\", \"name\": \"Velvet\", \"price\": 931541.96, \"subcategory\": \"nTOvnhogd2\", \"url\": \"https://www.mainunleash.name/ubiquitous/one-to-one/partnerships\" }"
```
