...
Received string:  "{  \"category\": \"Biography\",  \"description\": \"Anyway, he furnish the person.\",  \"id\": \"db700942-a2e5-4400-9bb3-55d0c5653598\",  \"name\": \"Bio\",  \"price\": 909130.9,  \"subcategory\": \"orlTOjF7tMAqx\",  \"url\": \"http://www.humanexpedite.org/granular/wireless/one-to-one\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Biography",  "description": "Anyway, he furnish the person.",  "id": "db700942-a2e5-4400-9bb3-55d0c5653598",  "name": "Bio",  "price": 909130.9,  "subcategory": "orlTOjF7tMAqx",  "url": "http://www.humanexpedite.org/granular/wireless/one-to-one"}"

```

```yaml
- text: "{ \"category\": \"Biography\", \"description\": \"Anyway, he furnish the person.\", \"id\": \"db700942-a2e5-4400-9bb3-55d0c5653598\", \"name\": \"Bio\", \"price\": 909130.9, \"subcategory\": \"orlTOjF7tMAqx\", \"url\": \"http://www.humanexpedite.org/granular/wireless/one-to-one\" }"
```
