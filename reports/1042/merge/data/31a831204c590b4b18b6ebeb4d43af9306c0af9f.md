...
Received string:  "{  \"category\": \"Adventure\",  \"description\": \"An school would path about still it roll few to bale party child week muster these what numerous them father really whatever along out.\",  \"id\": \"50fd3639-99ee-41f9-9c3c-0ca27766f827\",  \"keywords\": \"losiO twYYkO\",  \"name\": \"RiftValley\",  \"price\": 725610.46,  \"subcategory\": \"We VaxVz\",  \"url\": \"https://www.corporatetransparent.net/next-generation/sexy/interfaces/orchestrate\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Adventure",  "description": "An school would path about still it roll few to bale party child week muster these what numerous them father really whatever along out.",  "id": "50fd3639-99ee-41f9-9c3c-0ca27766f827",  "keywords": "losiO twYYkO",  "name": "RiftValley",  "price": 725610.46,  "subcategory": "We VaxVz",  "url": "https://www.corporatetransparent.net/next-generation/sexy/interfaces/orchestrate"}"

```

```yaml
- text: "{ \"category\": \"Adventure\", \"description\": \"An school would path about still it roll few to bale party child week muster these what numerous them father really whatever along out.\", \"id\": \"50fd3639-99ee-41f9-9c3c-0ca27766f827\", \"keywords\": \"losiO twYYkO\", \"name\": \"RiftValley\", \"price\": 725610.46, \"subcategory\": \"We VaxVz\", \"url\": \"https://www.corporatetransparent.net/next-generation/sexy/interfaces/orchestrate\" }"
```
