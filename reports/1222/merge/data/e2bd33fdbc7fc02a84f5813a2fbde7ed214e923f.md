...
Received string:  "{  \"category\": \"Travel\",  \"id\": \"55dd3a5c-d86d-4e61-b44c-d39ed10f8f6e\",  \"price\": 793787.63,  \"subcategory\": \"a\",  \"url\": \"https://www.salesviral.info/brand/facilitate\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Travel",  "id": "55dd3a5c-d86d-4e61-b44c-d39ed10f8f6e",  "price": 793787.63,  "subcategory": "a",  "url": "https://www.salesviral.info/brand/facilitate"}"

```

```yaml
- text: "{ \"category\": \"Travel\", \"id\": \"55dd3a5c-d86d-4e61-b44c-d39ed10f8f6e\", \"price\": 793787.63, \"subcategory\": \"a\", \"url\": \"https://www.salesviral.info/brand/facilitate\" }"
```
