...
Received string:  "{  \"category\": \"Mystery\",  \"description\": \"Might outrageous sadly its though stupidly some of gorgeous annually it which i.e. cook clap sister aha shall entirely his with tomorrow dress rarely.\",  \"id\": \"70e99f76-7093-43c7-b3dd-3ac2a93232b7\",  \"keywords\": \"yeSwVRXyggpiqmy\",  \"name\": \"KarmaKey\",  \"subcategory\": \"\",  \"url\": \"https://www.internalmetrics.name/e-services\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Mystery",  "description": "Might outrageous sadly its though stupidly some of gorgeous annually it which i.e. cook clap sister aha shall entirely his with tomorrow dress rarely.",  "id": "70e99f76-7093-43c7-b3dd-3ac2a93232b7",  "keywords": "yeSwVRXyggpiqmy",  "name": "KarmaKey",  "subcategory": "",  "url": "https://www.internalmetrics.name/e-services"}"

```

```yaml
- text: "{ \"category\": \"Mystery\", \"description\": \"Might outrageous sadly its though stupidly some of gorgeous annually it which i.e. cook clap sister aha shall entirely his with tomorrow dress rarely.\", \"id\": \"70e99f76-7093-43c7-b3dd-3ac2a93232b7\", \"keywords\": \"yeSwVRXyggpiqmy\", \"name\": \"KarmaKey\", \"subcategory\": \"\", \"url\": \"https://www.internalmetrics.name/e-services\" }"
```
