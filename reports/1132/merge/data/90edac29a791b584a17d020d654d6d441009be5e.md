...
Received string:  "{  \"category\": \"Finance\",  \"description\": \"Deliberately love the eye.\",  \"id\": \"ec0bb230-f73a-4dc1-9de1-7402a871c6fb\",  \"keywords\": \"TtCh\",  \"name\": \"SparkSphere\",  \"price\": 486061.31,  \"subcategory\": \"wCpriJKN\",  \"url\": \"https://www.futurebenchmark.io/wireless/next-generation/killer\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Finance",  "description": "Deliberately love the eye.",  "id": "ec0bb230-f73a-4dc1-9de1-7402a871c6fb",  "keywords": "TtCh",  "name": "SparkSphere",  "price": 486061.31,  "subcategory": "wCpriJKN",  "url": "https://www.futurebenchmark.io/wireless/next-generation/killer"}"

```

```yaml
- text: "{ \"category\": \"Finance\", \"description\": \"Deliberately love the eye.\", \"id\": \"ec0bb230-f73a-4dc1-9de1-7402a871c6fb\", \"keywords\": \"TtCh\", \"name\": \"SparkSphere\", \"price\": 486061.31, \"subcategory\": \"wCpriJKN\", \"url\": \"https://www.futurebenchmark.io/wireless/next-generation/killer\" }"
```
