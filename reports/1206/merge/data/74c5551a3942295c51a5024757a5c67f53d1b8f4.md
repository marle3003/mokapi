...
Received string:  "{  \"description\": \"Oops! Great progress on eye!\",  \"id\": \"2e087431-c329-42d2-b668-1b75fcdbe12a\",  \"keywords\": \"IbhSxxA\",  \"name\": \"Verve\",  \"price\": 369053,  \"url\": \"https://www.humanwireless.io/value-added/supply-chains/dot-com/plug-and-play\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "description": "Oops! Great progress on eye!",  "id": "2e087431-c329-42d2-b668-1b75fcdbe12a",  "keywords": "IbhSxxA",  "name": "Verve",  "price": 369053,  "url": "https://www.humanwireless.io/value-added/supply-chains/dot-com/plug-and-play"}"

```

```yaml
- text: "{ \"description\": \"Oops! Great progress on eye!\", \"id\": \"2e087431-c329-42d2-b668-1b75fcdbe12a\", \"keywords\": \"IbhSxxA\", \"name\": \"Verve\", \"price\": 369053, \"url\": \"https://www.humanwireless.io/value-added/supply-chains/dot-com/plug-and-play\" }"
```
