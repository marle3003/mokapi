...
Received string:  "{  \"category\": \"Religion\",  \"description\": \"Warm starts beat cold place.\",  \"id\": \"b45b0a33-bd24-4519-be6f-e5802c0d7cfd\",  \"name\": \"HorizonKey\",  \"price\": 528889.53,  \"subcategory\": \"jwjjzECKi\",  \"url\": \"https://www.internationaldrive.name/strategize/convergence/maximize\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Religion",  "description": "Warm starts beat cold place.",  "id": "b45b0a33-bd24-4519-be6f-e5802c0d7cfd",  "name": "HorizonKey",  "price": 528889.53,  "subcategory": "jwjjzECKi",  "url": "https://www.internationaldrive.name/strategize/convergence/maximize"}"

```

```yaml
- text: "{ \"category\": \"Religion\", \"description\": \"Warm starts beat cold place.\", \"id\": \"b45b0a33-bd24-4519-be6f-e5802c0d7cfd\", \"name\": \"HorizonKey\", \"price\": 528889.53, \"subcategory\": \"jwjjzECKi\", \"url\": \"https://www.internationaldrive.name/strategize/convergence/maximize\" }"
```
