...
Received string:  "{  \"category\": \"Design\",  \"description\": \"Durable life could worth the awareness.\",  \"id\": \"48c8a82e-b836-495b-9ff0-3c127d738916\",  \"keywords\": \"KvTue\",  \"name\": \"FrostForge\",  \"subcategory\": \"7\",  \"url\": \"http://www.futuremagnetic.io/back-end/e-tailers\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Design",  "description": "Durable life could worth the awareness.",  "id": "48c8a82e-b836-495b-9ff0-3c127d738916",  "keywords": "KvTue",  "name": "FrostForge",  "subcategory": "7",  "url": "http://www.futuremagnetic.io/back-end/e-tailers"}"

```

```yaml
- text: "{ \"category\": \"Design\", \"description\": \"Durable life could worth the awareness.\", \"id\": \"48c8a82e-b836-495b-9ff0-3c127d738916\", \"keywords\": \"KvTue\", \"name\": \"FrostForge\", \"subcategory\": \"7\", \"url\": \"http://www.futuremagnetic.io/back-end/e-tailers\" }"
```
