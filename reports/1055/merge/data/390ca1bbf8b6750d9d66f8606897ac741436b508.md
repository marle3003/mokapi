...
Received string:  "{  \"category\": \"Code\",  \"description\": \"Honduran we are ourselves once even person whatever we sleep enough somebody his am instance who marriage how shake over on below greatly mine never.\",  \"id\": \"80ab53a3-87b9-4f23-9966-9dfbc076d8c8\",  \"keywords\": \"Eh\",  \"name\": \"NebulaNest\",  \"price\": 680161.05,  \"subcategory\": \"p\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Code",  "description": "Honduran we are ourselves once even person whatever we sleep enough somebody his am instance who marriage how shake over on below greatly mine never.",  "id": "80ab53a3-87b9-4f23-9966-9dfbc076d8c8",  "keywords": "Eh",  "name": "NebulaNest",  "price": 680161.05,  "subcategory": "p"}"

```

```yaml
- text: "{ \"category\": \"Code\", \"description\": \"Honduran we are ourselves once even person whatever we sleep enough somebody his am instance who marriage how shake over on below greatly mine never.\", \"id\": \"80ab53a3-87b9-4f23-9966-9dfbc076d8c8\", \"keywords\": \"Eh\", \"name\": \"NebulaNest\", \"price\": 680161.05, \"subcategory\": \"p\" }"
```
