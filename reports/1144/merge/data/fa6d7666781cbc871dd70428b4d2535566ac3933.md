...
Received string:  "{  \"category\": \"Design\",  \"description\": \"Subtle MediumPurple accents do effective entirely.\",  \"keywords\": \"xP2nWeuayTp\",  \"price\": 304757.53,  \"subcategory\": \"LdocAYJnyGSnw\",  \"url\": \"http://www.executiveniches.name/user-centric/cross-media/turn-key/platforms\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Design",  "description": "Subtle MediumPurple accents do effective entirely.",  "keywords": "xP2nWeuayTp",  "price": 304757.53,  "subcategory": "LdocAYJnyGSnw",  "url": "http://www.executiveniches.name/user-centric/cross-media/turn-key/platforms"}"

```

```yaml
- text: "{ \"category\": \"Design\", \"description\": \"Subtle MediumPurple accents do effective entirely.\", \"keywords\": \"xP2nWeuayTp\", \"price\": 304757.53, \"subcategory\": \"LdocAYJnyGSnw\", \"url\": \"http://www.executiveniches.name/user-centric/cross-media/turn-key/platforms\" }"
```
