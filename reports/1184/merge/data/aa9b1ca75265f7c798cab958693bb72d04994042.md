...
Received string:  "{  \"category\": \"Literature\",  \"description\": \"Guide fact with difficult affordances.\",  \"id\": \"dd33b30f-96c3-4b1a-941a-60d7febe0c43\",  \"keywords\": \"mnDtbhP\",  \"name\": \"WillowSpark\",  \"price\": 936023.12,  \"subcategory\": \"ygMufPOLCaEYVyy\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Literature",  "description": "Guide fact with difficult affordances.",  "id": "dd33b30f-96c3-4b1a-941a-60d7febe0c43",  "keywords": "mnDtbhP",  "name": "WillowSpark",  "price": 936023.12,  "subcategory": "ygMufPOLCaEYVyy"}"

```

```yaml
- text: "{ \"category\": \"Literature\", \"description\": \"Guide fact with difficult affordances.\", \"id\": \"dd33b30f-96c3-4b1a-941a-60d7febe0c43\", \"keywords\": \"mnDtbhP\", \"name\": \"WillowSpark\", \"price\": 936023.12, \"subcategory\": \"ygMufPOLCaEYVyy\" }"
```
