...
Received string:  "12345678{  \"category\": \"Food\",  \"description\": \"Whom anything being everybody box Christian to bag ours his because that jump this away several me twist for husband hmm hand innocent anyway.\",  \"id\": \"739fdcf9-515e-46e5-b4eb-a37038c43225\",  \"price\": 88800.07,  \"subcategory\": \"owHOFIc4\",  \"url\": \"http://www.directvalue-added.com/world-class/holistic/transition\"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' })
    9 × locator resolved to <section data-v-4320bd73="" class="source json" aria-label="Content">…</section>
      - unexpected value "12345678{  "category": "Food",  "description": "Whom anything being everybody box Christian to bag ours his because that jump this away several me twist for husband hmm hand innocent anyway.",  "id": "739fdcf9-515e-46e5-b4eb-a37038c43225",  "price": 88800.07,  "subcategory": "owHOFIc4",  "url": "http://www.directvalue-added.com/world-class/holistic/transition"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 8 lines · 362 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 8"
                - text: "{ \"category\": \"Food\", \"description\": \"Whom anything being everybody box Christian to bag ours his because that jump this away several me twist for husband hmm hand innocent anyway.\", \"id\": \"739fdcf9-515e-46e5-b4eb-a37038c43225\", \"price\": 88800.07, \"subcategory\": \"owHOFIc4\", \"url\": \"http://www.directvalue-added.com/world-class/holistic/transition\" }"
            - status
            - button "Example"
            - button "Validate"
```
