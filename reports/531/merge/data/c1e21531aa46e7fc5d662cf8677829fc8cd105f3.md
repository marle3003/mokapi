...
Received string:  "12345678{  \"category\": \"Memoir\",  \"description\": \"Aristotelian park Kyrgyz person do loneliness some bravo ugly its today snore there look team than here that could lastly above after hail architect.\",  \"id\": \"9cc3ec06-c8ae-40dd-bfdf-0485034f0dfa\",  \"name\": \"FrostGuard\",  \"price\": 296416.59,  \"subcategory\": \"FUxb\"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' })
    9 × locator resolved to <section data-v-4320bd73="" class="source json" aria-label="Content">…</section>
      - unexpected value "12345678{  "category": "Memoir",  "description": "Aristotelian park Kyrgyz person do loneliness some bravo ugly its today snore there look team than here that could lastly above after hail architect.",  "id": "9cc3ec06-c8ae-40dd-bfdf-0485034f0dfa",  "name": "FrostGuard",  "price": 296416.59,  "subcategory": "FUxb"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 8 lines · 315 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 8"
                - text: "{ \"category\": \"Memoir\", \"description\": \"Aristotelian park Kyrgyz person do loneliness some bravo ugly its today snore there look team than here that could lastly above after hail architect.\", \"id\": \"9cc3ec06-c8ae-40dd-bfdf-0485034f0dfa\", \"name\": \"FrostGuard\", \"price\": 296416.59, \"subcategory\": \"FUxb\" }"
            - status
            - button "Example"
            - button "Validate"
```
