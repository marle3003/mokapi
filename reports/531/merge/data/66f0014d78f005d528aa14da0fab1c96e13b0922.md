...
Received string:  "1234{  \"userEmail\": \"hermanlegros@stanton.info\",  \"userId\": 6445}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.userSignedUp' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' })
    9 × locator resolved to <section data-v-4320bd73="" class="source json" aria-label="Content">…</section>
      - unexpected value "1234{  "userEmail": "hermanlegros@stanton.info",  "userId": 6445}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.userSignedUp":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 4 lines · 64 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 4"
                - text: "{ \"userEmail\": \"hermanlegros@stanton.info\", \"userId\": 6445 }"
            - status
            - button "Example"
            - button "Validate"
```
