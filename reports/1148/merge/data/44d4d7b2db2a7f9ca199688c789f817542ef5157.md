...
Received string:  "{  \"category\": \"Design\",  \"description\": \"Alternatively, they spread the time.\",  \"id\": \"9fa93f6e-7ce2-451f-8e19-74f7ec5f4385\",  \"name\": \"CrystalVeil\",  \"subcategory\": \"\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Design",  "description": "Alternatively, they spread the time.",  "id": "9fa93f6e-7ce2-451f-8e19-74f7ec5f4385",  "name": "CrystalVeil",  "subcategory": ""}"

```

```yaml
- text: "{ \"category\": \"Design\", \"description\": \"Alternatively, they spread the time.\", \"id\": \"9fa93f6e-7ce2-451f-8e19-74f7ec5f4385\", \"name\": \"CrystalVeil\", \"subcategory\": \"\" }"
```
