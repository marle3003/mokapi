...
Received string:  "{  \"category\": \"Cloud\",  \"description\": \"Compose man from simple parts.\",  \"keywords\": \"E3bslsIbmwlV7C\",  \"price\": 571776.22,  \"subcategory\": \"bmgmWkjsa\",  \"url\": \"https://www.customerinfrastructures.org/web-readiness/sticky\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Cloud",  "description": "Compose man from simple parts.",  "keywords": "E3bslsIbmwlV7C",  "price": 571776.22,  "subcategory": "bmgmWkjsa",  "url": "https://www.customerinfrastructures.org/web-readiness/sticky"}"

```

```yaml
- text: "{ \"category\": \"Cloud\", \"description\": \"Compose man from simple parts.\", \"keywords\": \"E3bslsIbmwlV7C\", \"price\": 571776.22, \"subcategory\": \"bmgmWkjsa\", \"url\": \"https://www.customerinfrastructures.org/web-readiness/sticky\" }"
```
