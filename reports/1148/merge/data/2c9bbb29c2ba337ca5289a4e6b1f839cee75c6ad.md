...
Received string:  "{  \"category\": \"Fitness\",  \"description\": \"Compare year before and after you wear.\",  \"id\": \"a5001207-e696-4e5a-8569-ee2b76058fee\",  \"keywords\": \"nXeRFZmlYlggosy\",  \"name\": \"IrisField\",  \"price\": 54830.45,  \"subcategory\": \"\",  \"url\": \"https://www.primarycompelling.info/distributed/repurpose/partnerships\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Fitness",  "description": "Compare year before and after you wear.",  "id": "a5001207-e696-4e5a-8569-ee2b76058fee",  "keywords": "nXeRFZmlYlggosy",  "name": "IrisField",  "price": 54830.45,  "subcategory": "",  "url": "https://www.primarycompelling.info/distributed/repurpose/partnerships"}"

```

```yaml
- text: "{ \"category\": \"Fitness\", \"description\": \"Compare year before and after you wear.\", \"id\": \"a5001207-e696-4e5a-8569-ee2b76058fee\", \"keywords\": \"nXeRFZmlYlggosy\", \"name\": \"IrisField\", \"price\": 54830.45, \"subcategory\": \"\", \"url\": \"https://www.primarycompelling.info/distributed/repurpose/partnerships\" }"
```
