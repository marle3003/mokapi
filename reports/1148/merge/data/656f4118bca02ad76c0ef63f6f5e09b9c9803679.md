...
Received string:  "{  \"category\": \"Fantasy\",  \"keywords\": \"Bcka7trmaEa\",  \"name\": \"JadeVoyage\",  \"price\": 327475.11,  \"subcategory\": \"nwuFzech5SD5xki\",  \"url\": \"http://www.divisionintuitive.org/e-business/relationships\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Fantasy",  "keywords": "Bcka7trmaEa",  "name": "JadeVoyage",  "price": 327475.11,  "subcategory": "nwuFzech5SD5xki",  "url": "http://www.divisionintuitive.org/e-business/relationships"}"

```

```yaml
- text: "{ \"category\": \"Fantasy\", \"keywords\": \"Bcka7trmaEa\", \"name\": \"JadeVoyage\", \"price\": 327475.11, \"subcategory\": \"nwuFzech5SD5xki\", \"url\": \"http://www.divisionintuitive.org/e-business/relationships\" }"
```
