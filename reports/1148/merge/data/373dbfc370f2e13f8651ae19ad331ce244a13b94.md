...
Received string:  "{  \"category\": \"Photo\",  \"description\": \"Warm starts beat cold woman.\",  \"keywords\": \"rYinas1auePfL\",  \"name\": \"ZephyrWing\",  \"subcategory\": \"RKhGb7A7$Jaez\",  \"url\": \"http://www.investorrevolutionary.com/revolutionize/exploit\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Photo",  "description": "Warm starts beat cold woman.",  "keywords": "rYinas1auePfL",  "name": "ZephyrWing",  "subcategory": "RKhGb7A7$Jaez",  "url": "http://www.investorrevolutionary.com/revolutionize/exploit"}"

```

```yaml
- text: "{ \"category\": \"Photo\", \"description\": \"Warm starts beat cold woman.\", \"keywords\": \"rYinas1auePfL\", \"name\": \"ZephyrWing\", \"subcategory\": \"RKhGb7A7$Jaez\", \"url\": \"http://www.investorrevolutionary.com/revolutionize/exploit\" }"
```
