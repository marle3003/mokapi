...
Received string:  "{  \"category\": \"Photo\",  \"description\": \"Alert on person thresholds then.\",  \"id\": \"726ee1f6-8141-4cde-8e3f-fd218776567a\",  \"keywords\": \"Dhf EqjOCjzl\",  \"name\": \"Aura\",  \"price\": 891931.5,  \"subcategory\": \"qJzP\",  \"url\": \"http://www.marketingclicks-and-mortar.com/whiteboard/users/redefine/e-markets\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Photo",  "description": "Alert on person thresholds then.",  "id": "726ee1f6-8141-4cde-8e3f-fd218776567a",  "keywords": "Dhf EqjOCjzl",  "name": "Aura",  "price": 891931.5,  "subcategory": "qJzP",  "url": "http://www.marketingclicks-and-mortar.com/whiteboard/users/redefine/e-markets"}"

```

```yaml
- text: "{ \"category\": \"Photo\", \"description\": \"Alert on person thresholds then.\", \"id\": \"726ee1f6-8141-4cde-8e3f-fd218776567a\", \"keywords\": \"Dhf EqjOCjzl\", \"name\": \"Aura\", \"price\": 891931.5, \"subcategory\": \"qJzP\", \"url\": \"http://www.marketingclicks-and-mortar.com/whiteboard/users/redefine/e-markets\" }"
```
