...
Received string:  "{  \"category\": \"Sports\",  \"description\": \"Quietly harden the way formerly.\",  \"id\": \"4a6b4f7a-8b8f-4610-82fa-688393b3860c\",  \"name\": \"Apex\",  \"subcategory\": \"\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Sports",  "description": "Quietly harden the way formerly.",  "id": "4a6b4f7a-8b8f-4610-82fa-688393b3860c",  "name": "Apex",  "subcategory": ""}"

```

```yaml
- text: "{ \"category\": \"Sports\", \"description\": \"Quietly harden the way formerly.\", \"id\": \"4a6b4f7a-8b8f-4610-82fa-688393b3860c\", \"name\": \"Apex\", \"subcategory\": \"\" }"
```
