...
Received string:  "{  \"category\": \"Self-Help\",  \"description\": \"Group year Finnish generously am ever can other Greek another all last yourself downstairs as its must crawl it double troop for have yay for will.\",  \"id\": \"1a4cade2-7a58-4154-b89c-a08ef1a714f4\",  \"keywords\": \"XuIU\",  \"name\": \"Quest\",  \"price\": 599371.69}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Self-Help",  "description": "Group year Finnish generously am ever can other Greek another all last yourself downstairs as its must crawl it double troop for have yay for will.",  "id": "1a4cade2-7a58-4154-b89c-a08ef1a714f4",  "keywords": "XuIU",  "name": "Quest",  "price": 599371.69}"

```

```yaml
- text: "{ \"category\": \"Self-Help\", \"description\": \"Group year Finnish generously am ever can other Greek another all last yourself downstairs as its must crawl it double troop for have yay for will.\", \"id\": \"1a4cade2-7a58-4154-b89c-a08ef1a714f4\", \"keywords\": \"XuIU\", \"name\": \"Quest\", \"price\": 599371.69 }"
```
