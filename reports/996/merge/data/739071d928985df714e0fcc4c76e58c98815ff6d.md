...
Received string:  "{  \"category\": \"Health\",  \"description\": \"Those to they of next model yourselves several snarl team others then wearily accordingly why sand what fade due some salary bread sleep problem eat.\",  \"keywords\": \"FvnBFkG\",  \"name\": \"MysticGlade\",  \"subcategory\": \"X1Nb\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Health",  "description": "Those to they of next model yourselves several snarl team others then wearily accordingly why sand what fade due some salary bread sleep problem eat.",  "keywords": "FvnBFkG",  "name": "MysticGlade",  "subcategory": "X1Nb"}"

```

```yaml
- text: "{ \"category\": \"Health\", \"description\": \"Those to they of next model yourselves several snarl team others then wearily accordingly why sand what fade due some salary bread sleep problem eat.\", \"keywords\": \"FvnBFkG\", \"name\": \"MysticGlade\", \"subcategory\": \"X1Nb\" }"
```
