...
Received string:  "{  \"category\": \"Music\",  \"description\": \"Ruthlessly remove dead thing.\",  \"id\": \"1061bc05-0bc7-4aa7-bb20-52adb115fc48\",  \"keywords\": \"wuCpyfEyiD\",  \"name\": \"ZephyrZone\",  \"price\": 805758.95,  \"subcategory\": \"OLknblq4w\",  \"url\": \"http://www.internationalubiquitous.info/dot-com/enhance/synergistic/systems\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Music",  "description": "Ruthlessly remove dead thing.",  "id": "1061bc05-0bc7-4aa7-bb20-52adb115fc48",  "keywords": "wuCpyfEyiD",  "name": "ZephyrZone",  "price": 805758.95,  "subcategory": "OLknblq4w",  "url": "http://www.internationalubiquitous.info/dot-com/enhance/synergistic/systems"}"

```

```yaml
- text: "{ \"category\": \"Music\", \"description\": \"Ruthlessly remove dead thing.\", \"id\": \"1061bc05-0bc7-4aa7-bb20-52adb115fc48\", \"keywords\": \"wuCpyfEyiD\", \"name\": \"ZephyrZone\", \"price\": 805758.95, \"subcategory\": \"OLknblq4w\", \"url\": \"http://www.internationalubiquitous.info/dot-com/enhance/synergistic/systems\" }"
```
