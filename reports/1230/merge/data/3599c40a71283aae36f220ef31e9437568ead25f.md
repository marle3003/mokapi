...
Received string:  "{  \"category\": \"Literature\",  \"description\": \"Align government with user intent.\",  \"keywords\": \"0wwGk.n\",  \"price\": 230121.26,  \"subcategory\": \"DxljabtbkIn\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Literature",  "description": "Align government with user intent.",  "keywords": "0wwGk.n",  "price": 230121.26,  "subcategory": "DxljabtbkIn"}"

```

```yaml
- text: "{ \"category\": \"Literature\", \"description\": \"Align government with user intent.\", \"keywords\": \"0wwGk.n\", \"price\": 230121.26, \"subcategory\": \"DxljabtbkIn\" }"
```
