...
Received string:  "{  \"id\": \"8520a7a4-351b-444b-ae9f-2b68ab0da7bc\",  \"keywords\": \"X\",  \"price\": 906875.35,  \"subcategory\": \"E6MemN\",  \"url\": \"https://www.investortechnologies.io/synergize/empower/embrace\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "id": "8520a7a4-351b-444b-ae9f-2b68ab0da7bc",  "keywords": "X",  "price": 906875.35,  "subcategory": "E6MemN",  "url": "https://www.investortechnologies.io/synergize/empower/embrace"}"

```

```yaml
- text: "{ \"id\": \"8520a7a4-351b-444b-ae9f-2b68ab0da7bc\", \"keywords\": \"X\", \"price\": 906875.35, \"subcategory\": \"E6MemN\", \"url\": \"https://www.investortechnologies.io/synergize/empower/embrace\" }"
```
