...
Received string:  "{  \"category\": \"Memoir\",  \"description\": \"Retire outdated time each quarter.\",  \"id\": \"0ee6f421-933d-4b03-9eee-a07ed6a58f20\",  \"keywords\": \"SJsBlN\",  \"name\": \"Kin\",  \"price\": 95761.3,  \"subcategory\": \"jJX\",  \"url\": \"https://www.futureexpedite.org/engage/bandwidth/engage/holistic\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Memoir",  "description": "Retire outdated time each quarter.",  "id": "0ee6f421-933d-4b03-9eee-a07ed6a58f20",  "keywords": "SJsBlN",  "name": "Kin",  "price": 95761.3,  "subcategory": "jJX",  "url": "https://www.futureexpedite.org/engage/bandwidth/engage/holistic"}"

```

```yaml
- text: "{ \"category\": \"Memoir\", \"description\": \"Retire outdated time each quarter.\", \"id\": \"0ee6f421-933d-4b03-9eee-a07ed6a58f20\", \"keywords\": \"SJsBlN\", \"name\": \"Kin\", \"price\": 95761.3, \"subcategory\": \"jJX\", \"url\": \"https://www.futureexpedite.org/engage/bandwidth/engage/holistic\" }"
```
