...
Received string:  "{  \"category\": \"Crafts\",  \"description\": \"As shake quickly brush the hand.\",  \"id\": \"478a5fd6-2ee8-4187-8c1f-a20cedb0637e\",  \"name\": \"Nexus\",  \"price\": 566759.19,  \"subcategory\": \"nau\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Crafts",  "description": "As shake quickly brush the hand.",  "id": "478a5fd6-2ee8-4187-8c1f-a20cedb0637e",  "name": "Nexus",  "price": 566759.19,  "subcategory": "nau"}"

```

```yaml
- text: "{ \"category\": \"Crafts\", \"description\": \"As shake quickly brush the hand.\", \"id\": \"478a5fd6-2ee8-4187-8c1f-a20cedb0637e\", \"name\": \"Nexus\", \"price\": 566759.19, \"subcategory\": \"nau\" }"
```
