...
Received string:  "{  \"category\": \"Life\",  \"description\": \"Retire outdated world each quarter.\",  \"id\": \"f491aca5-536e-41ce-8335-c7e5b6eabb74\",  \"keywords\": \"ofbBcUh\",  \"name\": \"PrismPulse\",  \"price\": 487491.77,  \"subcategory\": \"nDzIlAtu\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Life",  "description": "Retire outdated world each quarter.",  "id": "f491aca5-536e-41ce-8335-c7e5b6eabb74",  "keywords": "ofbBcUh",  "name": "PrismPulse",  "price": 487491.77,  "subcategory": "nDzIlAtu"}"

```

```yaml
- text: "{ \"category\": \"Life\", \"description\": \"Retire outdated world each quarter.\", \"id\": \"f491aca5-536e-41ce-8335-c7e5b6eabb74\", \"keywords\": \"ofbBcUh\", \"name\": \"PrismPulse\", \"price\": 487491.77, \"subcategory\": \"nDzIlAtu\" }"
```
