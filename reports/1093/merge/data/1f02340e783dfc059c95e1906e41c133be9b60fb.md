...
Received string:  "{  \"category\": \"Data\",  \"description\": \"Publish a changelog entry for the week.\",  \"id\": \"9cfe10e1-fd7c-49d2-b228-7dad76288e3c\",  \"keywords\": \"oOC5ia\",  \"name\": \"XenonXylo\",  \"price\": 33688.62,  \"subcategory\": \"3qO\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Data",  "description": "Publish a changelog entry for the week.",  "id": "9cfe10e1-fd7c-49d2-b228-7dad76288e3c",  "keywords": "oOC5ia",  "name": "XenonXylo",  "price": 33688.62,  "subcategory": "3qO"}"

```

```yaml
- text: "{ \"category\": \"Data\", \"description\": \"Publish a changelog entry for the week.\", \"id\": \"9cfe10e1-fd7c-49d2-b228-7dad76288e3c\", \"keywords\": \"oOC5ia\", \"name\": \"XenonXylo\", \"price\": 33688.62, \"subcategory\": \"3qO\" }"
```
