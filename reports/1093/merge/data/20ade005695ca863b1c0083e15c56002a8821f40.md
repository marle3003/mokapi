...
Received string:  "{  \"category\": \"Parenting\",  \"id\": \"6f496f6d-96e3-4b2e-8da5-a28edc64fa57\",  \"keywords\": \"N6wcDbti0miAIE\",  \"name\": \"KarmaKey\",  \"subcategory\": \"hJVqZbo0Y\",  \"url\": \"https://www.vicevisualize.com/magnetic/functionalities/proactive\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Parenting",  "id": "6f496f6d-96e3-4b2e-8da5-a28edc64fa57",  "keywords": "N6wcDbti0miAIE",  "name": "KarmaKey",  "subcategory": "hJVqZbo0Y",  "url": "https://www.vicevisualize.com/magnetic/functionalities/proactive"}"

```

```yaml
- text: "{ \"category\": \"Parenting\", \"id\": \"6f496f6d-96e3-4b2e-8da5-a28edc64fa57\", \"keywords\": \"N6wcDbti0miAIE\", \"name\": \"KarmaKey\", \"subcategory\": \"hJVqZbo0Y\", \"url\": \"https://www.vicevisualize.com/magnetic/functionalities/proactive\" }"
```
