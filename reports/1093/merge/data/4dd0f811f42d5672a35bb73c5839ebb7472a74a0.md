...
Received string:  "{  \"category\": \"Gaming\",  \"id\": \"5df10d57-0e0b-43cd-a7f3-b2343f3e6a0d\",  \"keywords\": \"\",  \"name\": \"Nova\",  \"price\": 22016.57,  \"subcategory\": \"sepsKxSvi\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Gaming",  "id": "5df10d57-0e0b-43cd-a7f3-b2343f3e6a0d",  "keywords": "",  "name": "Nova",  "price": 22016.57,  "subcategory": "sepsKxSvi"}"

```

```yaml
- text: "{ \"category\": \"Gaming\", \"id\": \"5df10d57-0e0b-43cd-a7f3-b2343f3e6a0d\", \"keywords\": \"\", \"name\": \"Nova\", \"price\": 22016.57, \"subcategory\": \"sepsKxSvi\" }"
```
