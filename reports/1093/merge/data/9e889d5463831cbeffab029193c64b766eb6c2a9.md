...
Received string:  "{  \"category\": \"Food\",  \"description\": \"Eventually, the woman occur frankly.\",  \"id\": \"1ec2c545-97a8-4f0a-8c7e-49d60e4f06f7\",  \"keywords\": \"bt99i2yFAgP\",  \"name\": \"MysticGlade\",  \"price\": 903930.2,  \"subcategory\": \"xt6brjsINL qC\",  \"url\": \"https://www.salesturn-key.biz/open-source/leading-edge/dynamic\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Food",  "description": "Eventually, the woman occur frankly.",  "id": "1ec2c545-97a8-4f0a-8c7e-49d60e4f06f7",  "keywords": "bt99i2yFAgP",  "name": "MysticGlade",  "price": 903930.2,  "subcategory": "xt6brjsINL qC",  "url": "https://www.salesturn-key.biz/open-source/leading-edge/dynamic"}"

```

```yaml
- text: "{ \"category\": \"Food\", \"description\": \"Eventually, the woman occur frankly.\", \"id\": \"1ec2c545-97a8-4f0a-8c7e-49d60e4f06f7\", \"keywords\": \"bt99i2yFAgP\", \"name\": \"MysticGlade\", \"price\": 903930.2, \"subcategory\": \"xt6brjsINL qC\", \"url\": \"https://www.salesturn-key.biz/open-source/leading-edge/dynamic\" }"
```
