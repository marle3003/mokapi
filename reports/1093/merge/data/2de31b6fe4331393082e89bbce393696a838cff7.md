...
Received string:  "{  \"category\": \"Science\",  \"description\": \"Onward to better week!\",  \"id\": \"a24bd998-5344-4459-882d-69712d72b47c\",  \"keywords\": \"NFdvaZXhi\",  \"name\": \"Evolve\",  \"price\": 371012.99,  \"subcategory\": \"oCKOfqHFBrjcq\",  \"url\": \"https://www.executivereintermediate.info/open-source\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Science",  "description": "Onward to better week!",  "id": "a24bd998-5344-4459-882d-69712d72b47c",  "keywords": "NFdvaZXhi",  "name": "Evolve",  "price": 371012.99,  "subcategory": "oCKOfqHFBrjcq",  "url": "https://www.executivereintermediate.info/open-source"}"

```

```yaml
- text: "{ \"category\": \"Science\", \"description\": \"Onward to better week!\", \"id\": \"a24bd998-5344-4459-882d-69712d72b47c\", \"keywords\": \"NFdvaZXhi\", \"name\": \"Evolve\", \"price\": 371012.99, \"subcategory\": \"oCKOfqHFBrjcq\", \"url\": \"https://www.executivereintermediate.info/open-source\" }"
```
