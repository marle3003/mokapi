...
Received string:  "{  \"category\": \"Tech\",  \"description\": \"Quietly harden the problem before.\",  \"id\": \"11e5dff2-9a8d-40ce-86a0-a98557f7d11b\",  \"keywords\": \"akc7cIX\",  \"name\": \"Beam\",  \"price\": 530677.16,  \"subcategory\": \"jnuGPzi\",  \"url\": \"http://www.systemsrepurpose.info/benchmark\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Tech",  "description": "Quietly harden the problem before.",  "id": "11e5dff2-9a8d-40ce-86a0-a98557f7d11b",  "keywords": "akc7cIX",  "name": "Beam",  "price": 530677.16,  "subcategory": "jnuGPzi",  "url": "http://www.systemsrepurpose.info/benchmark"}"

```

```yaml
- text: "{ \"category\": \"Tech\", \"description\": \"Quietly harden the problem before.\", \"id\": \"11e5dff2-9a8d-40ce-86a0-a98557f7d11b\", \"keywords\": \"akc7cIX\", \"name\": \"Beam\", \"price\": 530677.16, \"subcategory\": \"jnuGPzi\", \"url\": \"http://www.systemsrepurpose.info/benchmark\" }"
```
