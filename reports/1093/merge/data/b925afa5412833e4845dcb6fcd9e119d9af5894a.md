...
Received string:  "{  \"category\": \"Games\",  \"description\": \"Sample fact at 6s intervals.\",  \"id\": \"f32cb68b-3bda-4fdc-a3fa-c5eef2f0adc4\",  \"keywords\": \"TZp:ujbIyPSyC\",  \"name\": \"Vital\",  \"price\": 185786.86,  \"subcategory\": \"JmverkFEgBch\",  \"url\": \"https://www.groupgranular.biz/bricks-and-clicks\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Games",  "description": "Sample fact at 6s intervals.",  "id": "f32cb68b-3bda-4fdc-a3fa-c5eef2f0adc4",  "keywords": "TZp:ujbIyPSyC",  "name": "Vital",  "price": 185786.86,  "subcategory": "JmverkFEgBch",  "url": "https://www.groupgranular.biz/bricks-and-clicks"}"

```

```yaml
- text: "{ \"category\": \"Games\", \"description\": \"Sample fact at 6s intervals.\", \"id\": \"f32cb68b-3bda-4fdc-a3fa-c5eef2f0adc4\", \"keywords\": \"TZp:ujbIyPSyC\", \"name\": \"Vital\", \"price\": 185786.86, \"subcategory\": \"JmverkFEgBch\", \"url\": \"https://www.groupgranular.biz/bricks-and-clicks\" }"
```
