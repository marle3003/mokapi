...
Received string:  "{  \"category\": \"Travel\",  \"description\": \"Mornings in San Francisco favor week.\",  \"id\": \"b0e933c7-64b8-4ab6-b76e-1c89776511d3\",  \"keywords\": \"Jw#CPQiadwl\",  \"name\": \"Envis\",  \"price\": 626285.83,  \"subcategory\": \"iBnqxe\",  \"url\": \"http://www.directunleash.name/architect\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Travel",  "description": "Mornings in San Francisco favor week.",  "id": "b0e933c7-64b8-4ab6-b76e-1c89776511d3",  "keywords": "Jw#CPQiadwl",  "name": "Envis",  "price": 626285.83,  "subcategory": "iBnqxe",  "url": "http://www.directunleash.name/architect"}"

```

```yaml
- text: "{ \"category\": \"Travel\", \"description\": \"Mornings in San Francisco favor week.\", \"id\": \"b0e933c7-64b8-4ab6-b76e-1c89776511d3\", \"keywords\": \"Jw#CPQiadwl\", \"name\": \"Envis\", \"price\": 626285.83, \"subcategory\": \"iBnqxe\", \"url\": \"http://www.directunleash.name/architect\" }"
```
