...
Received string:  "{  \"category\": \"Business\",  \"description\": \"Guide world with fine affordances.\",  \"id\": \"bac94bee-175f-4138-9a1a-724344b6ac7c\",  \"keywords\": \"biT\",  \"name\": \"Meadow\",  \"price\": 5008.41,  \"url\": \"http://www.clientparadigms.name/bleeding-edge/b2b/exploit/granular\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Business",  "description": "Guide world with fine affordances.",  "id": "bac94bee-175f-4138-9a1a-724344b6ac7c",  "keywords": "biT",  "name": "Meadow",  "price": 5008.41,  "url": "http://www.clientparadigms.name/bleeding-edge/b2b/exploit/granular"}"

```

```yaml
- text: "{ \"category\": \"Business\", \"description\": \"Guide world with fine affordances.\", \"id\": \"bac94bee-175f-4138-9a1a-724344b6ac7c\", \"keywords\": \"biT\", \"name\": \"Meadow\", \"price\": 5008.41, \"url\": \"http://www.clientparadigms.name/bleeding-edge/b2b/exploit/granular\" }"
```
