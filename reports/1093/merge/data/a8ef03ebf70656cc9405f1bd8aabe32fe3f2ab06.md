...
Received string:  "{  \"category\": \"Art\",  \"description\": \"Sample thing at 28s intervals.\",  \"id\": \"eec7e644-d1e1-4625-902b-738976776996\",  \"keywords\": \"kaf\",  \"name\": \"Arc\",  \"price\": 325395.34,  \"subcategory\": \"qjLRE\",  \"url\": \"http://www.nationalconvergence.net/redefine/methodologies\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Art",  "description": "Sample thing at 28s intervals.",  "id": "eec7e644-d1e1-4625-902b-738976776996",  "keywords": "kaf",  "name": "Arc",  "price": 325395.34,  "subcategory": "qjLRE",  "url": "http://www.nationalconvergence.net/redefine/methodologies"}"

```

```yaml
- text: "{ \"category\": \"Art\", \"description\": \"Sample thing at 28s intervals.\", \"id\": \"eec7e644-d1e1-4625-902b-738976776996\", \"keywords\": \"kaf\", \"name\": \"Arc\", \"price\": 325395.34, \"subcategory\": \"qjLRE\", \"url\": \"http://www.nationalconvergence.net/redefine/methodologies\" }"
```
