...
Received string:  "{  \"category\": \"Architecture\",  \"description\": \"Map the happy path through problem.\",  \"id\": \"a0bbe815-0b93-4741-8edd-a5e480077a8e\",  \"keywords\": \"zSFyhWXt\",  \"name\": \"Amity\",  \"price\": 467957.04,  \"subcategory\": \"owPrvsF\",  \"url\": \"https://www.primaryexperiences.org/back-end/e-services/customized/magnetic\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Architecture",  "description": "Map the happy path through problem.",  "id": "a0bbe815-0b93-4741-8edd-a5e480077a8e",  "keywords": "zSFyhWXt",  "name": "Amity",  "price": 467957.04,  "subcategory": "owPrvsF",  "url": "https://www.primaryexperiences.org/back-end/e-services/customized/magnetic"}"

```

```yaml
- text: "{ \"category\": \"Architecture\", \"description\": \"Map the happy path through problem.\", \"id\": \"a0bbe815-0b93-4741-8edd-a5e480077a8e\", \"keywords\": \"zSFyhWXt\", \"name\": \"Amity\", \"price\": 467957.04, \"subcategory\": \"owPrvsF\", \"url\": \"https://www.primaryexperiences.org/back-end/e-services/customized/magnetic\" }"
```
