...
Received string:  "{  \"category\": \"Apps\",  \"description\": \"Stage number behind feature flags.\",  \"id\": \"c87ee015-5f06-4758-8d47-a12224071eaf\",  \"keywords\": \"lDbfmcJRjfR\",  \"name\": \"Zeal\",  \"price\": 455767.79,  \"subcategory\": \"IQIwoeP3cG\",  \"url\": \"http://www.headaggregate.info/b2c\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Apps",  "description": "Stage number behind feature flags.",  "id": "c87ee015-5f06-4758-8d47-a12224071eaf",  "keywords": "lDbfmcJRjfR",  "name": "Zeal",  "price": 455767.79,  "subcategory": "IQIwoeP3cG",  "url": "http://www.headaggregate.info/b2c"}"

```

```yaml
- text: "{ \"category\": \"Apps\", \"description\": \"Stage number behind feature flags.\", \"id\": \"c87ee015-5f06-4758-8d47-a12224071eaf\", \"keywords\": \"lDbfmcJRjfR\", \"name\": \"Zeal\", \"price\": 455767.79, \"subcategory\": \"IQIwoeP3cG\", \"url\": \"http://www.headaggregate.info/b2c\" }"
```
