...
Received string:  "{  \"category\": \"Garden\",  \"description\": \"Compose part from simple parts.\",  \"id\": \"5d125bda-3516-497c-921c-ba580b048ea3\",  \"name\": \"DeltaWave\",  \"subcategory\": \"}Wj\",  \"url\": \"http://www.businessoptimize.net/ubiquitous\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Garden",  "description": "Compose part from simple parts.",  "id": "5d125bda-3516-497c-921c-ba580b048ea3",  "name": "DeltaWave",  "subcategory": "}Wj",  "url": "http://www.businessoptimize.net/ubiquitous"}"

```

```yaml
- text: "{ \"category\": \"Garden\", \"description\": \"Compose part from simple parts.\", \"id\": \"5d125bda-3516-497c-921c-ba580b048ea3\", \"name\": \"DeltaWave\", \"subcategory\": \"}Wj\", \"url\": \"http://www.businessoptimize.net/ubiquitous\" }"
```
