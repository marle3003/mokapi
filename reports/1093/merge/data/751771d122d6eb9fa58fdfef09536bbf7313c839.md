...
Received string:  "{  \"category\": \"Horror\",  \"description\": \"Practice group drills regularly.\",  \"id\": \"9bce1de4-d4a4-4486-8917-c1bbe482872d\",  \"keywords\": \"sNY\",  \"name\": \"FrostGuard\",  \"price\": 170035.67,  \"subcategory\": \"pb\",  \"url\": \"http://www.nationalstreamline.biz/visionary/morph/e-tailers/incubate\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Horror",  "description": "Practice group drills regularly.",  "id": "9bce1de4-d4a4-4486-8917-c1bbe482872d",  "keywords": "sNY",  "name": "FrostGuard",  "price": 170035.67,  "subcategory": "pb",  "url": "http://www.nationalstreamline.biz/visionary/morph/e-tailers/incubate"}"

```

```yaml
- text: "{ \"category\": \"Horror\", \"description\": \"Practice group drills regularly.\", \"id\": \"9bce1de4-d4a4-4486-8917-c1bbe482872d\", \"keywords\": \"sNY\", \"name\": \"FrostGuard\", \"price\": 170035.67, \"subcategory\": \"pb\", \"url\": \"http://www.nationalstreamline.biz/visionary/morph/e-tailers/incubate\" }"
```
