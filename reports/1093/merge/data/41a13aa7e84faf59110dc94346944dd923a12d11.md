...
Received string:  "{  \"category\": \"Media\",  \"description\": \"The irritation am be nice completely.\",  \"id\": \"50e5e43a-234b-454d-be7a-4f0561e24076\",  \"keywords\": \"PECnxwgd\",  \"name\": \"BloomCrest\",  \"price\": 545784.63,  \"url\": \"http://www.mainwebservices.biz/enterprise/infrastructures/grow\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Media",  "description": "The irritation am be nice completely.",  "id": "50e5e43a-234b-454d-be7a-4f0561e24076",  "keywords": "PECnxwgd",  "name": "BloomCrest",  "price": 545784.63,  "url": "http://www.mainwebservices.biz/enterprise/infrastructures/grow"}"

```

```yaml
- text: "{ \"category\": \"Media\", \"description\": \"The irritation am be nice completely.\", \"id\": \"50e5e43a-234b-454d-be7a-4f0561e24076\", \"keywords\": \"PECnxwgd\", \"name\": \"BloomCrest\", \"price\": 545784.63, \"url\": \"http://www.mainwebservices.biz/enterprise/infrastructures/grow\" }"
```
