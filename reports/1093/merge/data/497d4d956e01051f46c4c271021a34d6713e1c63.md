...
Received string:  "{  \"category\": \"Design\",  \"id\": \"635ab5e8-f210-42e9-a89e-596e5e4830ab\",  \"name\": \"Fuse\",  \"price\": 272545.23,  \"url\": \"http://www.chieforchestrate.org/generate\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Design",  "id": "635ab5e8-f210-42e9-a89e-596e5e4830ab",  "name": "Fuse",  "price": 272545.23,  "url": "http://www.chieforchestrate.org/generate"}"

```

```yaml
- text: "{ \"category\": \"Design\", \"id\": \"635ab5e8-f210-42e9-a89e-596e5e4830ab\", \"name\": \"Fuse\", \"price\": 272545.23, \"url\": \"http://www.chieforchestrate.org/generate\" }"
```
