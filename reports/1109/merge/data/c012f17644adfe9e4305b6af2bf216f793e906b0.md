...
Received string:  "{  \"category\": \"Entertainment\",  \"description\": \"Bravo! Great progress on government!\",  \"id\": \"c55d2f2a-a906-4c17-a93c-4d8601731561\",  \"keywords\": \"sjhfXGHEmG\",  \"name\": \"Unity\",  \"price\": 662543.56,  \"subcategory\": \"zLH\",  \"url\": \"http://www.deputysexy.org/reinvent/strategic/initiatives\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Entertainment",  "description": "Bravo! Great progress on government!",  "id": "c55d2f2a-a906-4c17-a93c-4d8601731561",  "keywords": "sjhfXGHEmG",  "name": "Unity",  "price": 662543.56,  "subcategory": "zLH",  "url": "http://www.deputysexy.org/reinvent/strategic/initiatives"}"

```

```yaml
- text: "{ \"category\": \"Entertainment\", \"description\": \"Bravo! Great progress on government!\", \"id\": \"c55d2f2a-a906-4c17-a93c-4d8601731561\", \"keywords\": \"sjhfXGHEmG\", \"name\": \"Unity\", \"price\": 662543.56, \"subcategory\": \"zLH\", \"url\": \"http://www.deputysexy.org/reinvent/strategic/initiatives\" }"
```
