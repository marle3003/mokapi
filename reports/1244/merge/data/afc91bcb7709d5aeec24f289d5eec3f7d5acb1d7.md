...
Received string:  "{  \"category\": \"Beauty\",  \"description\": \"Durable work been worth the right.\",  \"keywords\": \"U|D\",  \"name\": \"Amity\",  \"price\": 53774.93,  \"subcategory\": \"uR0bmRQxXtwt\",  \"url\": \"http://www.districtarchitect.name/value-added/24-7/channels/reintermediate\"}"
Timeout: 5000ms

Call log:
  - Expect "toHaveText" getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content') with timeout 5000ms
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Beauty",  "description": "Durable work been worth the right.",  "keywords": "U|D",  "name": "Amity",  "price": 53774.93,  "subcategory": "uR0bmRQxXtwt",  "url": "http://www.districtarchitect.name/value-added/24-7/channels/reintermediate"}"

```

```yaml
- text: "{ \"category\": \"Beauty\", \"description\": \"Durable work been worth the right.\", \"keywords\": \"U|D\", \"name\": \"Amity\", \"price\": 53774.93, \"subcategory\": \"uR0bmRQxXtwt\", \"url\": \"http://www.districtarchitect.name/value-added/24-7/channels/reintermediate\" }"
```
