...
Received string:  "{  \"category\": \"Fashion\",  \"id\": \"5b555eb1-5679-41f0-b9ac-5de750a80fd9\",  \"keywords\": \"Noe\",  \"price\": 953037.33,  \"subcategory\": \"\",  \"url\": \"https://www.viceexperiences.biz/e-business/repurpose/best-of-breed/matrix\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Fashion",  "id": "5b555eb1-5679-41f0-b9ac-5de750a80fd9",  "keywords": "Noe",  "price": 953037.33,  "subcategory": "",  "url": "https://www.viceexperiences.biz/e-business/repurpose/best-of-breed/matrix"}"

```

```yaml
- text: "{ \"category\": \"Fashion\", \"id\": \"5b555eb1-5679-41f0-b9ac-5de750a80fd9\", \"keywords\": \"Noe\", \"price\": 953037.33, \"subcategory\": \"\", \"url\": \"https://www.viceexperiences.biz/e-business/repurpose/best-of-breed/matrix\" }"
```
