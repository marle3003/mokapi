...
Received string:  "{  \"category\": \"Books\",  \"description\": \"Subtle OrangeRed accents did effective so.\",  \"id\": \"e84537e8-5d82-4004-ae58-ffa326308417\",  \"keywords\": \"djpeL\",  \"name\": \"PhantomRidge\",  \"price\": 276787.9,  \"subcategory\": \"ELeaS\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Books",  "description": "Subtle OrangeRed accents did effective so.",  "id": "e84537e8-5d82-4004-ae58-ffa326308417",  "keywords": "djpeL",  "name": "PhantomRidge",  "price": 276787.9,  "subcategory": "ELeaS"}"

```

```yaml
- text: "{ \"category\": \"Books\", \"description\": \"Subtle OrangeRed accents did effective so.\", \"id\": \"e84537e8-5d82-4004-ae58-ffa326308417\", \"keywords\": \"djpeL\", \"name\": \"PhantomRidge\", \"price\": 276787.9, \"subcategory\": \"ELeaS\" }"
```
