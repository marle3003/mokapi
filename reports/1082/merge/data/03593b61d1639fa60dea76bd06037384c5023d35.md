...
Received string:  "{  \"category\": \"Life\",  \"description\": \"Ruthlessly remove dead time.\",  \"keywords\": \"\",  \"name\": \"YieldPath\",  \"price\": 626691.02,  \"subcategory\": \"ZT aD5FN\",  \"url\": \"https://www.juniorsexy.com/value-added/sexy/innovate\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Life",  "description": "Ruthlessly remove dead time.",  "keywords": "",  "name": "YieldPath",  "price": 626691.02,  "subcategory": "ZT aD5FN",  "url": "https://www.juniorsexy.com/value-added/sexy/innovate"}"

```

```yaml
- text: "{ \"category\": \"Life\", \"description\": \"Ruthlessly remove dead time.\", \"keywords\": \"\", \"name\": \"YieldPath\", \"price\": 626691.02, \"subcategory\": \"ZT aD5FN\", \"url\": \"https://www.juniorsexy.com/value-added/sexy/innovate\" }"
```
