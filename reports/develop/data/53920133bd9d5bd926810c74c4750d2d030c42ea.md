...
Received string:  "{  \"category\": \"Gaming\",  \"description\": \"At bird this smoggy soon yourself eye pretty according gain it only are theirs this huh of some rise several near why everything hers none turn.\",  \"id\": \"ffcd877c-dbf2-4e06-9edf-9eb9af076cfe\",  \"keywords\": \"X\",  \"name\": \"SparkVenture\",  \"price\": 190151.57,  \"subcategory\": \"ipPJTKyzr9cnK\",  \"url\": \"http://www.futuresynergistic.info/markets/dynamic/functionalities\"}"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    9 × locator resolved to <div class="ace_content">…</div>
      - unexpected value "{  "category": "Gaming",  "description": "At bird this smoggy soon yourself eye pretty according gain it only are theirs this huh of some rise several near why everything hers none turn.",  "id": "ffcd877c-dbf2-4e06-9edf-9eb9af076cfe",  "keywords": "X",  "name": "SparkVenture",  "price": 190151.57,  "subcategory": "ipPJTKyzr9cnK",  "url": "http://www.futuresynergistic.info/markets/dynamic/functionalities"}"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 10 lines · 418 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
