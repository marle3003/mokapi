...
Received string:  "12345678910{  \"category\": \"Travel\",  \"description\": \"Theirs no even i.e. him gee a why myself there its who had yesterday whichever an what wake another our those through mine of anyone mine himself.\",  \"id\": \"d579ec33-04a8-437b-b80c-9e2dfe4b7911\",  \"keywords\": \"iVrxnailL8rBF\",  \"name\": \"Hex\",  \"price\": 188982.23,  \"subcategory\": \"CocLEzr\",  \"url\": \"http://www.dynamiccommunities.org/harness/integrate/matrix\"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 10 lines · 410 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 10"
                - text: "{ \"category\": \"Travel\", \"description\": \"Theirs no even i.e. him gee a why myself there its who had yesterday whichever an what wake another our those through mine of anyone mine himself.\", \"id\": \"d579ec33-04a8-437b-b80c-9e2dfe4b7911\", \"keywords\": \"iVrxnailL8rBF\", \"name\": \"Hex\", \"price\": 188982.23, \"subcategory\": \"CocLEzr\", \"url\": \"http://www.dynamiccommunities.org/harness/integrate/matrix\" }"
            - status
            - button "Example"
            - button "Validate"
```
