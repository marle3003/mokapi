...
Received string:  "{  \"keywords\": \"r\",  \"name\": \"CelestialPath\",  \"price\": 238436.38}"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    9 × locator resolved to <div class="ace_content">…</div>
      - unexpected value "{  "keywords": "r",  "name": "CelestialPath",  "price": 238436.38}"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 5 lines · 70 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 5"
                - text: "{ \"keywords\": \"r\", \"name\": \"CelestialPath\", \"price\": 238436.38 }"
            - status
            - button "Example"
            - button "Validate"
```
