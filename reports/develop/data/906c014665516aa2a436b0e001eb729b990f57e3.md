...
Received string:  "123456789{  \"category\": \"Gaming\",  \"description\": \"Then that stress singer about anyway time that quietly eye hey jittery rise chaos what on case whom of lie to my theirs thing.\",  \"id\": \"90810f50-5415-40c9-b37a-8d1c9a332861\",  \"keywords\": \"tihKMokJ\",  \"price\": 864092.56,  \"subcategory\": \"ohWlQNgLp\",  \"url\": \"http://www.globale-tailers.org/bleeding-edge/back-end\"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' })
    9 × locator resolved to <section data-v-4320bd73="" class="source json" aria-label="Content">…</section>
      - unexpected value "123456789{  "category": "Gaming",  "description": "Then that stress singer about anyway time that quietly eye hey jittery rise chaos what on case whom of lie to my theirs thing.",  "id": "90810f50-5415-40c9-b37a-8d1c9a332861",  "keywords": "tihKMokJ",  "price": 864092.56,  "subcategory": "ohWlQNgLp",  "url": "http://www.globale-tailers.org/bleeding-edge/back-end"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 9 lines · 365 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 9"
                - text: "{ \"category\": \"Gaming\", \"description\": \"Then that stress singer about anyway time that quietly eye hey jittery rise chaos what on case whom of lie to my theirs thing.\", \"id\": \"90810f50-5415-40c9-b37a-8d1c9a332861\", \"keywords\": \"tihKMokJ\", \"price\": 864092.56, \"subcategory\": \"ohWlQNgLp\", \"url\": \"http://www.globale-tailers.org/bleeding-edge/back-end\" }"
            - status
            - button "Example"
            - button "Validate"
```
