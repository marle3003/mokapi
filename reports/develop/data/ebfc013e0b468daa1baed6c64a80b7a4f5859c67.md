...
Received string:  "1234567{  \"category\": \"Education\",  \"id\": \"438fbc38-57a2-4a6a-a35b-d72686d27fdc\",  \"name\": \"UmbraPhase\",  \"price\": 86251.98,  \"url\": \"https://www.principalstrategize.net/communities/dot-com/infrastructures/metrics\"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' })
    9 × locator resolved to <section data-v-4320bd73="" class="source json" aria-label="Content">…</section>
      - unexpected value "1234567{  "category": "Education",  "id": "438fbc38-57a2-4a6a-a35b-d72686d27fdc",  "name": "UmbraPhase",  "price": 86251.98,  "url": "https://www.principalstrategize.net/communities/dot-com/infrastructures/metrics"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 7 lines · 214 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 7"
                - text: "{ \"category\": \"Education\", \"id\": \"438fbc38-57a2-4a6a-a35b-d72686d27fdc\", \"name\": \"UmbraPhase\", \"price\": 86251.98, \"url\": \"https://www.principalstrategize.net/communities/dot-com/infrastructures/metrics\" }"
            - status
            - button "Example"
            - button "Validate"
```
