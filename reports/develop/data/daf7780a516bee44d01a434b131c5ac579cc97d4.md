...
Received string:  "12345678{  \"category\": \"Fantasy\",  \"description\": \"For who English its hers secondly to somebody today dark tomorrow before yay today their yikes which we coat from Viennese to these pool he into her.\",  \"keywords\": \"JnNuwxcUFhRkA\",  \"price\": 367682.08,  \"subcategory\": \"ymrlLNaoNzsP\",  \"url\": \"https://www.globalinfrastructures.biz/utilize\"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' })
    9 × locator resolved to <section data-v-4320bd73="" class="source json" aria-label="Content">…</section>
      - unexpected value "12345678{  "category": "Fantasy",  "description": "For who English its hers secondly to somebody today dark tomorrow before yay today their yikes which we coat from Viennese to these pool he into her.",  "keywords": "JnNuwxcUFhRkA",  "price": 367682.08,  "subcategory": "ymrlLNaoNzsP",  "url": "https://www.globalinfrastructures.biz/utilize"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 8 lines · 341 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 8"
                - text: "{ \"category\": \"Fantasy\", \"description\": \"For who English its hers secondly to somebody today dark tomorrow before yay today their yikes which we coat from Viennese to these pool he into her.\", \"keywords\": \"JnNuwxcUFhRkA\", \"price\": 367682.08, \"subcategory\": \"ymrlLNaoNzsP\", \"url\": \"https://www.globalinfrastructures.biz/utilize\" }"
            - status
            - button "Example"
            - button "Validate"
```
