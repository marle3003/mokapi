...
Received string:  "12345678{  \"category\": \"Home & Garden\",  \"description\": \"Opposite this whale himself off theirs work themselves say to does over weekly it whatever Bangladeshi as hatred few half how it salt on sufficient.\",  \"keywords\": \"JGnnXltpDxudBt\",  \"name\": \"VortexEdge\",  \"subcategory\": \"JiaoTLvMBIzdeNs\",  \"url\": \"https://www.regionalroi.name/synergistic/transparent\"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' })
    9 × locator resolved to <section data-v-4320bd73="" class="source json" aria-label="Content">…</section>
      - unexpected value "12345678{  "category": "Home & Garden",  "description": "Opposite this whale himself off theirs work themselves say to does over weekly it whatever Bangladeshi as hatred few half how it salt on sufficient.",  "keywords": "JGnnXltpDxudBt",  "name": "VortexEdge",  "subcategory": "JiaoTLvMBIzdeNs",  "url": "https://www.regionalroi.name/synergistic/transparent"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 8 lines · 359 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 8"
                - text: "{ \"category\": \"Home & Garden\", \"description\": \"Opposite this whale himself off theirs work themselves say to does over weekly it whatever Bangladeshi as hatred few half how it salt on sufficient.\", \"keywords\": \"JGnnXltpDxudBt\", \"name\": \"VortexEdge\", \"subcategory\": \"JiaoTLvMBIzdeNs\", \"url\": \"https://www.regionalroi.name/synergistic/transparent\" }"
            - status
            - button "Example"
            - button "Validate"
```
