...
Received string:  "1234567{  \"description\": \"Help roughly without what however virtually there safety it our first weekly well anyone over picture cast itself now salt example herself in must.\",  \"id\": \"f9014784-0af5-4db4-b7ec-ad0498e7500c\",  \"keywords\": \"oWXeMex\",  \"price\": 305122.85,  \"url\": \"http://www.centralrevolutionary.name/optimize/aggregate/facilitate\"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' })
    9 × locator resolved to <section data-v-4320bd73="" class="source json" aria-label="Content">…</section>
      - unexpected value "1234567{  "description": "Help roughly without what however virtually there safety it our first weekly well anyone over picture cast itself now salt example herself in must.",  "id": "f9014784-0af5-4db4-b7ec-ad0498e7500c",  "keywords": "oWXeMex",  "price": 305122.85,  "url": "http://www.centralrevolutionary.name/optimize/aggregate/facilitate"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 7 lines · 344 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 7"
                - text: "{ \"description\": \"Help roughly without what however virtually there safety it our first weekly well anyone over picture cast itself now salt example herself in must.\", \"id\": \"f9014784-0af5-4db4-b7ec-ad0498e7500c\", \"keywords\": \"oWXeMex\", \"price\": 305122.85, \"url\": \"http://www.centralrevolutionary.name/optimize/aggregate/facilitate\" }"
            - status
            - button "Example"
            - button "Validate"
```
