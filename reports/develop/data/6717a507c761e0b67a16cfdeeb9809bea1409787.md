...
Received string:  "{  \"description\": \"Ouch over nest first finally yesterday that now I ouch besides at of therefore just can soon less themselves he how were leap mirror.\",  \"id\": \"a2bae254-6369-40d4-a84c-dd640e07f3fe\",  \"keywords\": \"1toquBaCm\",  \"name\": \"VortexValley\"}"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    9 × locator resolved to <div class="ace_content">…</div>
      - unexpected value "{  "description": "Ouch over nest first finally yesterday that now I ouch besides at of therefore just can soon less themselves he how were leap mirror.",  "id": "a2bae254-6369-40d4-a84c-dd640e07f3fe",  "keywords": "1toquBaCm",  "name": "VortexValley"}"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 6 lines · 257 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 6"
                - text: "{ \"description\": \"Ouch over nest first finally yesterday that now I ouch besides at of therefore just can soon less themselves he how were leap mirror.\", \"id\": \"a2bae254-6369-40d4-a84c-dd640e07f3fe\", \"keywords\": \"1toquBaCm\", \"name\": \"VortexValley\" }"
            - status
            - button "Example"
            - button "Validate"
```
