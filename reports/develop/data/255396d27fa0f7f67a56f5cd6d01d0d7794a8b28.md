...
Received string:  "12345678{  \"category\": \"Pets\",  \"description\": \"Are though daily daily block her of time whom yours their all between once Egyptian they flock in its been describe hers horde wade.\",  \"id\": \"d95adcc1-8bf5-4e7a-bcf6-54ac25b2df91\",  \"keywords\": \"mCPWgPngxyPL2\",  \"name\": \"Evolve\",  \"price\": 349035.81}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' })
    9 × locator resolved to <section data-v-4320bd73="" class="source json" aria-label="Content">…</section>
      - unexpected value "12345678{  "category": "Pets",  "description": "Are though daily daily block her of time whom yours their all between once Egyptian they flock in its been describe hers horde wade.",  "id": "d95adcc1-8bf5-4e7a-bcf6-54ac25b2df91",  "keywords": "mCPWgPngxyPL2",  "name": "Evolve",  "price": 349035.81}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 8 lines · 298 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 8"
                - text: "{ \"category\": \"Pets\", \"description\": \"Are though daily daily block her of time whom yours their all between once Egyptian they flock in its been describe hers horde wade.\", \"id\": \"d95adcc1-8bf5-4e7a-bcf6-54ac25b2df91\", \"keywords\": \"mCPWgPngxyPL2\", \"name\": \"Evolve\", \"price\": 349035.81 }"
            - status
            - button "Example"
            - button "Validate"
```
