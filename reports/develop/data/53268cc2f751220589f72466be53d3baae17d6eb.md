...
Received string:  "123456789{  \"category\": \"Fantasy\",  \"description\": \"May had Aristotelian as yours his these where exaltation why how homeless ours were his whom always there then daughter market mine my along will.\",  \"id\": \"cf210dd1-4cf2-4502-9310-572cc71dd9e2\",  \"keywords\": \"X7ZoBWh\",  \"name\": \"Arctic\",  \"price\": 115862.31,  \"subcategory\": \"n\"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' })
    9 × locator resolved to <section data-v-4320bd73="" class="source json" aria-label="Content">…</section>
      - unexpected value "123456789{  "category": "Fantasy",  "description": "May had Aristotelian as yours his these where exaltation why how homeless ours were his whom always there then daughter market mine my along will.",  "id": "cf210dd1-4cf2-4502-9310-572cc71dd9e2",  "keywords": "X7ZoBWh",  "name": "Arctic",  "price": 115862.31,  "subcategory": "n"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 9 lines · 331 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 9"
                - text: "{ \"category\": \"Fantasy\", \"description\": \"May had Aristotelian as yours his these where exaltation why how homeless ours were his whom always there then daughter market mine my along will.\", \"id\": \"cf210dd1-4cf2-4502-9310-572cc71dd9e2\", \"keywords\": \"X7ZoBWh\", \"name\": \"Arctic\", \"price\": 115862.31, \"subcategory\": \"n\" }"
            - status
            - button "Example"
            - button "Validate"
```
