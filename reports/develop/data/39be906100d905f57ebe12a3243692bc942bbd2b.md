...
Received string:  "12345{  \"description\": \"Outside say of accordingly hurry elephant think sheaf itself those of my safety yourself shower there at man so Himalayan for stand still must.\",  \"name\": \"Unity\",  \"price\": 603839.41}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 5 lines · 207 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 5"
                - text: "{ \"description\": \"Outside say of accordingly hurry elephant think sheaf itself those of my safety yourself shower there at man so Himalayan for stand still must.\", \"name\": \"Unity\", \"price\": 603839.41 }"
            - status
            - button "Example"
            - button "Validate"
```
