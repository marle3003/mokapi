...
Received string:  "12345{  \"category\": \"Drama\",  \"description\": \"Upon from this hiccup every here time Nepalese climb mine tomorrow then did alas in doctor run whose read stand your scenic scenic.\",  \"url\": \"http://www.chiefinfomediaries.com/infrastructures/leading-edge/e-tailers\"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' })
    9 × locator resolved to <section data-v-4320bd73="" class="source json" aria-label="Content">…</section>
      - unexpected value "12345{  "category": "Drama",  "description": "Upon from this hiccup every here time Nepalese climb mine tomorrow then did alas in doctor run whose read stand your scenic scenic.",  "url": "http://www.chiefinfomediaries.com/infrastructures/leading-edge/e-tailers"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 5 lines · 262 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 5"
                - text: "{ \"category\": \"Drama\", \"description\": \"Upon from this hiccup every here time Nepalese climb mine tomorrow then did alas in doctor run whose read stand your scenic scenic.\", \"url\": \"http://www.chiefinfomediaries.com/infrastructures/leading-edge/e-tailers\" }"
            - status
            - button "Example"
            - button "Validate"
```
