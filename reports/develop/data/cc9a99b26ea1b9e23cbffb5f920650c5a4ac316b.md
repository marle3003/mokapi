...
Received string:  "{  \"description\": \"Untie onto there brilliance now where hand father phew are yikes almost addition life in fortnightly pack damage those pack usually nothing who.\",  \"id\": \"ba276083-c232-4310-a71a-c5be8859a1fb\",  \"keywords\": \"wrwT\",  \"price\": 753345.94,  \"subcategory\": \"PjmGSDNLu\",  \"url\": \"https://www.regionalexpedite.net/grow\"}"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    9 × locator resolved to <div class="ace_content">…</div>
      - unexpected value "{  "description": "Untie onto there brilliance now where hand father phew are yikes almost addition life in fortnightly pack damage those pack usually nothing who.",  "id": "ba276083-c232-4310-a71a-c5be8859a1fb",  "keywords": "wrwT",  "price": 753345.94,  "subcategory": "PjmGSDNLu",  "url": "https://www.regionalexpedite.net/grow"}"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 8 lines · 339 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 8"
                - text: "{ \"description\": \"Untie onto there brilliance now where hand father phew are yikes almost addition life in fortnightly pack damage those pack usually nothing who.\", \"id\": \"ba276083-c232-4310-a71a-c5be8859a1fb\", \"keywords\": \"wrwT\", \"price\": 753345.94, \"subcategory\": \"PjmGSDNLu\", \"url\": \"https://www.regionalexpedite.net/grow\" }"
            - status
            - button "Example"
            - button "Validate"
```
