...
Received string:  "{  \"description\": \"Sometimes the person spin frequently.\",  \"id\": \"41c80fd4-10fc-421c-9833-53fe2655e882\",  \"keywords\": \"kQvRXfc{XIoy\",  \"name\": \"Lux\",  \"subcategory\": \"6\",  \"url\": \"https://www.divisionleading-edge.org/action-items/visionary/optimize/cutting-edge\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "description": "Sometimes the person spin frequently.",  "id": "41c80fd4-10fc-421c-9833-53fe2655e882",  "keywords": "kQvRXfc{XIoy",  "name": "Lux",  "subcategory": "6",  "url": "https://www.divisionleading-edge.org/action-items/visionary/optimize/cutting-edge"}"

```

```yaml
- text: "{ \"description\": \"Sometimes the person spin frequently.\", \"id\": \"41c80fd4-10fc-421c-9833-53fe2655e882\", \"keywords\": \"kQvRXfc{XIoy\", \"name\": \"Lux\", \"subcategory\": \"6\", \"url\": \"https://www.divisionleading-edge.org/action-items/visionary/optimize/cutting-edge\" }"
```
