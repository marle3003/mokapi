...
Received string:  "{  \"category\": \"Science\",  \"description\": \"Clear place have better than clever part.\",  \"id\": \"b968e15c-58e0-4d82-954b-0c7348d619ab\",  \"keywords\": \"GXgefO1yZKwhorj\",  \"price\": 556066.41,  \"subcategory\": \"zULveeT\",  \"url\": \"http://www.nationalcross-media.biz/integrate/scalable\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Science",  "description": "Clear place have better than clever part.",  "id": "b968e15c-58e0-4d82-954b-0c7348d619ab",  "keywords": "GXgefO1yZKwhorj",  "price": 556066.41,  "subcategory": "zULveeT",  "url": "http://www.nationalcross-media.biz/integrate/scalable"}"

```

```yaml
- text: "{ \"category\": \"Science\", \"description\": \"Clear place have better than clever part.\", \"id\": \"b968e15c-58e0-4d82-954b-0c7348d619ab\", \"keywords\": \"GXgefO1yZKwhorj\", \"price\": 556066.41, \"subcategory\": \"zULveeT\", \"url\": \"http://www.nationalcross-media.biz/integrate/scalable\" }"
```
