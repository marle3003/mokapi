...
Received string:  "{  \"category\": \"History\",  \"description\": \"Explicitly name the life before you viplate it.\",  \"id\": \"15b422e4-e301-43c4-822e-8267dfec113b\",  \"keywords\": \"kN\",  \"name\": \"Zebra\",  \"price\": 599755.24,  \"subcategory\": \" 7vNxc\",  \"url\": \"http://www.internaliterate.biz/synergies\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "History",  "description": "Explicitly name the life before you viplate it.",  "id": "15b422e4-e301-43c4-822e-8267dfec113b",  "keywords": "kN",  "name": "Zebra",  "price": 599755.24,  "subcategory": " 7vNxc",  "url": "http://www.internaliterate.biz/synergies"}"

```

```yaml
- text: "{ \"category\": \"History\", \"description\": \"Explicitly name the life before you viplate it.\", \"id\": \"15b422e4-e301-43c4-822e-8267dfec113b\", \"keywords\": \"kN\", \"name\": \"Zebra\", \"price\": 599755.24, \"subcategory\": \" 7vNxc\", \"url\": \"http://www.internaliterate.biz/synergies\" }"
```
