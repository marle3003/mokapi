...
Received string:  "{  \"category\": \"Beauty\",  \"description\": \"Draw a diagram for the woman greedily.\",  \"id\": \"815e5d54-55b7-43ec-9f84-26b8f9294b06\",  \"keywords\": \" u\",  \"name\": \"OrionQuest\",  \"price\": 419777.3,  \"subcategory\": \"GiyZGHJLyta\",  \"url\": \"https://www.juniorseamless.com/intuitive/user-centric/distributed\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Beauty",  "description": "Draw a diagram for the woman greedily.",  "id": "815e5d54-55b7-43ec-9f84-26b8f9294b06",  "keywords": " u",  "name": "OrionQuest",  "price": 419777.3,  "subcategory": "GiyZGHJLyta",  "url": "https://www.juniorseamless.com/intuitive/user-centric/distributed"}"

```

```yaml
- text: "{ \"category\": \"Beauty\", \"description\": \"Draw a diagram for the woman greedily.\", \"id\": \"815e5d54-55b7-43ec-9f84-26b8f9294b06\", \"keywords\": \" u\", \"name\": \"OrionQuest\", \"price\": 419777.3, \"subcategory\": \"GiyZGHJLyta\", \"url\": \"https://www.juniorseamless.com/intuitive/user-centric/distributed\" }"
```
