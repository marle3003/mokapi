...
Received string:  "{  \"category\": \"Tech\",  \"description\": \"Raise contrast where the child hides.\",  \"id\": \"a476e817-86ce-4363-b1ee-67835b23153c\",  \"keywords\": \"buite\",  \"price\": 669558.65,  \"subcategory\": \"bmd bgA_\",  \"url\": \"http://www.productsyndicate.io/b2c\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Tech",  "description": "Raise contrast where the child hides.",  "id": "a476e817-86ce-4363-b1ee-67835b23153c",  "keywords": "buite",  "price": 669558.65,  "subcategory": "bmd bgA_",  "url": "http://www.productsyndicate.io/b2c"}"

```

```yaml
- text: "{ \"category\": \"Tech\", \"description\": \"Raise contrast where the child hides.\", \"id\": \"a476e817-86ce-4363-b1ee-67835b23153c\", \"keywords\": \"buite\", \"price\": 669558.65, \"subcategory\": \"bmd bgA_\", \"url\": \"http://www.productsyndicate.io/b2c\" }"
```
