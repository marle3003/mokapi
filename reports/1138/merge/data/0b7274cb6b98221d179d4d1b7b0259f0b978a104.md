...
Received string:  "{  \"category\": \"Art\",  \"description\": \"Ours man was ready for delay.\",  \"id\": \"cb4e584c-7155-40dc-9b0c-1ffc2f21cdc5\",  \"keywords\": \"plyfmaeUr\",  \"name\": \"Swift\",  \"price\": 754631.78,  \"subcategory\": \"HVqhtoOfslzujk\",  \"url\": \"http://www.forward24-365.info/value-added/cross-platform/integrate/paradigms\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Art",  "description": "Ours man was ready for delay.",  "id": "cb4e584c-7155-40dc-9b0c-1ffc2f21cdc5",  "keywords": "plyfmaeUr",  "name": "Swift",  "price": 754631.78,  "subcategory": "HVqhtoOfslzujk",  "url": "http://www.forward24-365.info/value-added/cross-platform/integrate/paradigms"}"

```

```yaml
- text: "{ \"category\": \"Art\", \"description\": \"Ours man was ready for delay.\", \"id\": \"cb4e584c-7155-40dc-9b0c-1ffc2f21cdc5\", \"keywords\": \"plyfmaeUr\", \"name\": \"Swift\", \"price\": 754631.78, \"subcategory\": \"HVqhtoOfslzujk\", \"url\": \"http://www.forward24-365.info/value-added/cross-platform/integrate/paradigms\" }"
```
