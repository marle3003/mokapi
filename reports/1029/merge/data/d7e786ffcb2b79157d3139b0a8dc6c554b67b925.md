...
Received string:  "{  \"category\": \"Food\",  \"description\": \"You someone run hedge why into child where to ever already there what now every yesterday swing American some has I this would hmm that thoughtfully.\",  \"id\": \"6608db14-1df6-4436-82c7-4e7a0597b4b0\",  \"keywords\": \"RryvCurofgmDnKk\",  \"name\": \"NebulaNest\",  \"price\": 724489.91,  \"subcategory\": \"p\",  \"url\": \"http://www.principalvisualize.biz/seamless\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Food",  "description": "You someone run hedge why into child where to ever already there what now every yesterday swing American some has I this would hmm that thoughtfully.",  "id": "6608db14-1df6-4436-82c7-4e7a0597b4b0",  "keywords": "RryvCurofgmDnKk",  "name": "NebulaNest",  "price": 724489.91,  "subcategory": "p",  "url": "http://www.principalvisualize.biz/seamless"}"

```

```yaml
- text: "{ \"category\": \"Food\", \"description\": \"You someone run hedge why into child where to ever already there what now every yesterday swing American some has I this would hmm that thoughtfully.\", \"id\": \"6608db14-1df6-4436-82c7-4e7a0597b4b0\", \"keywords\": \"RryvCurofgmDnKk\", \"name\": \"NebulaNest\", \"price\": 724489.91, \"subcategory\": \"p\", \"url\": \"http://www.principalvisualize.biz/seamless\" }"
```
