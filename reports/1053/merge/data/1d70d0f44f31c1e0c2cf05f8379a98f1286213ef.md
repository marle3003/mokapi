...
Received string:  "{  \"category\": \"Data\",  \"description\": \"Ours toast luxuty stupidly myself you murder you cheerful before my is much finally theirs juice without cackle next dazzle even so down government.\",  \"id\": \"aec949de-45e5-4c98-ad77-da334a8734aa\",  \"keywords\": \"H\",  \"name\": \"InfinityLoop\",  \"price\": 899026.73,  \"url\": \"http://www.seniormarkets.biz/architect/target/communities/bandwidth\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Data",  "description": "Ours toast luxuty stupidly myself you murder you cheerful before my is much finally theirs juice without cackle next dazzle even so down government.",  "id": "aec949de-45e5-4c98-ad77-da334a8734aa",  "keywords": "H",  "name": "InfinityLoop",  "price": 899026.73,  "url": "http://www.seniormarkets.biz/architect/target/communities/bandwidth"}"

```

```yaml
- text: "{ \"category\": \"Data\", \"description\": \"Ours toast luxuty stupidly myself you murder you cheerful before my is much finally theirs juice without cackle next dazzle even so down government.\", \"id\": \"aec949de-45e5-4c98-ad77-da334a8734aa\", \"keywords\": \"H\", \"name\": \"InfinityLoop\", \"price\": 899026.73, \"url\": \"http://www.seniormarkets.biz/architect/target/communities/bandwidth\" }"
```
