...
Received string:  "{  \"category\": \"Sports\",  \"id\": \"aeb5c562-55f7-4c7f-8d8f-002af08a03f2\",  \"keywords\": \"VzfFvfr\",  \"name\": \"LunarFlare\",  \"price\": 304064.48,  \"url\": \"https://www.operationsmindshare.net/value-added/turn-key/e-services/scale\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Sports",  "id": "aeb5c562-55f7-4c7f-8d8f-002af08a03f2",  "keywords": "VzfFvfr",  "name": "LunarFlare",  "price": 304064.48,  "url": "https://www.operationsmindshare.net/value-added/turn-key/e-services/scale"}"

```

```yaml
- text: "{ \"category\": \"Sports\", \"id\": \"aeb5c562-55f7-4c7f-8d8f-002af08a03f2\", \"keywords\": \"VzfFvfr\", \"name\": \"LunarFlare\", \"price\": 304064.48, \"url\": \"https://www.operationsmindshare.net/value-added/turn-key/e-services/scale\" }"
```
