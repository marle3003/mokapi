...
Received string:  "{  \"category\": \"Music\",  \"description\": \"Outside for gang it you it our suitcase place of kiss who exaltation American so last trip your petrify kindness stemmed scold afterwards am upon so.\",  \"keywords\": \"agHoyN6aLjrHWxa\",  \"name\": \"BlazeCraft\",  \"price\": 637148.06,  \"subcategory\": \"LrQug3vi\",  \"url\": \"http://www.principalrich.org/end-to-end/implement\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Music",  "description": "Outside for gang it you it our suitcase place of kiss who exaltation American so last trip your petrify kindness stemmed scold afterwards am upon so.",  "keywords": "agHoyN6aLjrHWxa",  "name": "BlazeCraft",  "price": 637148.06,  "subcategory": "LrQug3vi",  "url": "http://www.principalrich.org/end-to-end/implement"}"

```

```yaml
- text: "{ \"category\": \"Music\", \"description\": \"Outside for gang it you it our suitcase place of kiss who exaltation American so last trip your petrify kindness stemmed scold afterwards am upon so.\", \"keywords\": \"agHoyN6aLjrHWxa\", \"name\": \"BlazeCraft\", \"price\": 637148.06, \"subcategory\": \"LrQug3vi\", \"url\": \"http://www.principalrich.org/end-to-end/implement\" }"
```
