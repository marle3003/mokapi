...
Received string:  "{  \"category\": \"Tools\",  \"description\": \"Wake contrast scream as fly just on eyes as how packet trip several occasion dive certain each indeed this phew how her yearly where yikes upon for.\",  \"id\": \"57a9a0e2-96ff-462b-8eb2-673750c5ad4d\",  \"name\": \"InfinityLoop\",  \"price\": 514715.84,  \"subcategory\": \"uKBb.ujql\",  \"url\": \"http://www.customerubiquitous.io/repurpose/channels\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Tools",  "description": "Wake contrast scream as fly just on eyes as how packet trip several occasion dive certain each indeed this phew how her yearly where yikes upon for.",  "id": "57a9a0e2-96ff-462b-8eb2-673750c5ad4d",  "name": "InfinityLoop",  "price": 514715.84,  "subcategory": "uKBb.ujql",  "url": "http://www.customerubiquitous.io/repurpose/channels"}"

```

```yaml
- text: "{ \"category\": \"Tools\", \"description\": \"Wake contrast scream as fly just on eyes as how packet trip several occasion dive certain each indeed this phew how her yearly where yikes upon for.\", \"id\": \"57a9a0e2-96ff-462b-8eb2-673750c5ad4d\", \"name\": \"InfinityLoop\", \"price\": 514715.84, \"subcategory\": \"uKBb.ujql\", \"url\": \"http://www.customerubiquitous.io/repurpose/channels\" }"
```
