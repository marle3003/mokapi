...
Received string:  "{  \"description\": \"Mine gallop till listen here it up tame in near we nightly besides zealous to eek a are their in pod might in which about each leap should.\",  \"id\": \"3d2be825-6251-4983-865e-910561c04040\",  \"keywords\": \"7hUZ\",  \"name\": \"Jet\",  \"price\": 182497.52,  \"subcategory\": \"vwc  FtR\",  \"url\": \"https://www.legacyrevolutionize.com/transition/innovate/best-of-breed\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "description": "Mine gallop till listen here it up tame in near we nightly besides zealous to eek a are their in pod might in which about each leap should.",  "id": "3d2be825-6251-4983-865e-910561c04040",  "keywords": "7hUZ",  "name": "Jet",  "price": 182497.52,  "subcategory": "vwc  FtR",  "url": "https://www.legacyrevolutionize.com/transition/innovate/best-of-breed"}"

```

```yaml
- text: "{ \"description\": \"Mine gallop till listen here it up tame in near we nightly besides zealous to eek a are their in pod might in which about each leap should.\", \"id\": \"3d2be825-6251-4983-865e-910561c04040\", \"keywords\": \"7hUZ\", \"name\": \"Jet\", \"price\": 182497.52, \"subcategory\": \"vwc FtR\", \"url\": \"https://www.legacyrevolutionize.com/transition/innovate/best-of-breed\" }"
```
