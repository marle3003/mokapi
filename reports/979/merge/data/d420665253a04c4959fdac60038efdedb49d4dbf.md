...
Received string:  "{  \"category\": \"Social\",  \"description\": \"At any wolf who which cigarette where still an your nest than any sheaf next ours someone philosophy how hmm why which straightaway finally float.\",  \"id\": \"ecc25dcf-6f60-4453-b505-fc26cabb689d\",  \"keywords\": \"KagtjDQE4fBrFOV\",  \"name\": \"Ivy\",  \"price\": 569959.3,  \"subcategory\": \"ezbqwslv7tq\",  \"url\": \"https://www.internationalgenerate.name/orchestrate/cultivate\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Social",  "description": "At any wolf who which cigarette where still an your nest than any sheaf next ours someone philosophy how hmm why which straightaway finally float.",  "id": "ecc25dcf-6f60-4453-b505-fc26cabb689d",  "keywords": "KagtjDQE4fBrFOV",  "name": "Ivy",  "price": 569959.3,  "subcategory": "ezbqwslv7tq",  "url": "https://www.internationalgenerate.name/orchestrate/cultivate"}"

```

```yaml
- text: "{ \"category\": \"Social\", \"description\": \"At any wolf who which cigarette where still an your nest than any sheaf next ours someone philosophy how hmm why which straightaway finally float.\", \"id\": \"ecc25dcf-6f60-4453-b505-fc26cabb689d\", \"keywords\": \"KagtjDQE4fBrFOV\", \"name\": \"Ivy\", \"price\": 569959.3, \"subcategory\": \"ezbqwslv7tq\", \"url\": \"https://www.internationalgenerate.name/orchestrate/cultivate\" }"
```
