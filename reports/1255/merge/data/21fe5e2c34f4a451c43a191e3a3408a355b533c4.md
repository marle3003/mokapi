...
Received string:  "{  \"category\": \"Drama\",  \"name\": \"Evolve\",  \"price\": 341248.81,  \"subcategory\": \"qYfGDnLr\",  \"url\": \"http://www.primaryaction-items.biz/drive\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Drama",  "name": "Evolve",  "price": 341248.81,  "subcategory": "qYfGDnLr",  "url": "http://www.primaryaction-items.biz/drive"}"

```

```yaml
- text: "{ \"category\": \"Drama\", \"name\": \"Evolve\", \"price\": 341248.81, \"subcategory\": \"qYfGDnLr\", \"url\": \"http://www.primaryaction-items.biz/drive\" }"
```
