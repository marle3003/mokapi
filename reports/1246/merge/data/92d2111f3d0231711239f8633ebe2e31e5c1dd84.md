...
Received string:  "{  \"description\": \"Scope the life to fit the moment.\",  \"keywords\": \"xhlzNuj5Hma t\",  \"name\": \"Legend\",  \"subcategory\": \"PRqKv1s}aoV\",  \"url\": \"https://www.centralwebservices.net/end-to-end/bricks-and-clicks/syndicate/models\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "description": "Scope the life to fit the moment.",  "keywords": "xhlzNuj5Hma t",  "name": "Legend",  "subcategory": "PRqKv1s}aoV",  "url": "https://www.centralwebservices.net/end-to-end/bricks-and-clicks/syndicate/models"}"

```

```yaml
- text: "{ \"description\": \"Scope the life to fit the moment.\", \"keywords\": \"xhlzNuj5Hma t\", \"name\": \"Legend\", \"subcategory\": \"PRqKv1s}aoV\", \"url\": \"https://www.centralwebservices.net/end-to-end/bricks-and-clicks/syndicate/models\" }"
```
