...
Received string:  "{  \"category\": \"Apps\",  \"description\": \"The time will upset.\",  \"id\": \"80db3882-0650-4f16-a8fa-8ac52dc1610d\",  \"keywords\": \"\",  \"name\": \"Legend\",  \"price\": 698881.46,  \"subcategory\": \"a\",  \"url\": \"https://www.dynamicoptimize.net/granular\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Apps",  "description": "The time will upset.",  "id": "80db3882-0650-4f16-a8fa-8ac52dc1610d",  "keywords": "",  "name": "Legend",  "price": 698881.46,  "subcategory": "a",  "url": "https://www.dynamicoptimize.net/granular"}"

```

```yaml
- text: "{ \"category\": \"Apps\", \"description\": \"The time will upset.\", \"id\": \"80db3882-0650-4f16-a8fa-8ac52dc1610d\", \"keywords\": \"\", \"name\": \"Legend\", \"price\": 698881.46, \"subcategory\": \"a\", \"url\": \"https://www.dynamicoptimize.net/granular\" }"
```
