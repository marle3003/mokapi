...
Received string:  "{  \"category\": \"Code\",  \"description\": \"Review the case every 4 weeks.\",  \"id\": \"23c207a1-9574-4968-9ad3-7efa56fb1fd4\",  \"keywords\": \"\",  \"name\": \"OrionTrail\",  \"price\": 191704.82,  \"subcategory\": \"Mrxlqiq\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Code",  "description": "Review the case every 4 weeks.",  "id": "23c207a1-9574-4968-9ad3-7efa56fb1fd4",  "keywords": "",  "name": "OrionTrail",  "price": 191704.82,  "subcategory": "Mrxlqiq"}"

```

```yaml
- text: "{ \"category\": \"Code\", \"description\": \"Review the case every 4 weeks.\", \"id\": \"23c207a1-9574-4968-9ad3-7efa56fb1fd4\", \"keywords\": \"\", \"name\": \"OrionTrail\", \"price\": 191704.82, \"subcategory\": \"Mrxlqiq\" }"
```
