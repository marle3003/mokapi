...
Received string:  "{  \"category\": \"Drama\",  \"description\": \"Gee! Ship the place now!\",  \"name\": \"JasperJunction\",  \"subcategory\": \"qzlU\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Drama",  "description": "Gee! Ship the place now!",  "name": "JasperJunction",  "subcategory": "qzlU"}"

```

```yaml
- text: "{ \"category\": \"Drama\", \"description\": \"Gee! Ship the place now!\", \"name\": \"JasperJunction\", \"subcategory\": \"qzlU\" }"
```
