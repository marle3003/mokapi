...
Received string:  "{  \"category\": \"Music\",  \"description\": \"Practice part drills regularly.\",  \"keywords\": \"RsqjOmA\",  \"name\": \"Jet\",  \"price\": 264280.19,  \"subcategory\": \"Ad\",  \"url\": \"https://www.publicenhance.org/supply-chains/webservices/supply-chains/frictionless\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Music",  "description": "Practice part drills regularly.",  "keywords": "RsqjOmA",  "name": "Jet",  "price": 264280.19,  "subcategory": "Ad",  "url": "https://www.publicenhance.org/supply-chains/webservices/supply-chains/frictionless"}"

```

```yaml
- text: "{ \"category\": \"Music\", \"description\": \"Practice part drills regularly.\", \"keywords\": \"RsqjOmA\", \"name\": \"Jet\", \"price\": 264280.19, \"subcategory\": \"Ad\", \"url\": \"https://www.publicenhance.org/supply-chains/webservices/supply-chains/frictionless\" }"
```
