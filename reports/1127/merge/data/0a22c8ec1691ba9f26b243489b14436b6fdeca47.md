...
Received string:  "{  \"category\": \"Design\",  \"description\": \"Stage year behind feature flags.\",  \"id\": \"dda0a851-5a72-46b4-8103-14b1e36c3b61\",  \"keywords\": \"nEm\",  \"name\": \"Stellar\",  \"price\": 320292.75,  \"subcategory\": \"HUmfXaXdcbeEUzc\",  \"url\": \"https://www.legacyunleash.name/strategize/collaborative/repurpose\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Design",  "description": "Stage year behind feature flags.",  "id": "dda0a851-5a72-46b4-8103-14b1e36c3b61",  "keywords": "nEm",  "name": "Stellar",  "price": 320292.75,  "subcategory": "HUmfXaXdcbeEUzc",  "url": "https://www.legacyunleash.name/strategize/collaborative/repurpose"}"

```

```yaml
- text: "{ \"category\": \"Design\", \"description\": \"Stage year behind feature flags.\", \"id\": \"dda0a851-5a72-46b4-8103-14b1e36c3b61\", \"keywords\": \"nEm\", \"name\": \"Stellar\", \"price\": 320292.75, \"subcategory\": \"HUmfXaXdcbeEUzc\", \"url\": \"https://www.legacyunleash.name/strategize/collaborative/repurpose\" }"
```
