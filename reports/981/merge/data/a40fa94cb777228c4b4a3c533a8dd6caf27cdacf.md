...
Received string:  "{  \"category\": \"Entertainment\",  \"description\": \"That woman where smiling yearly till a poorly day abroad mob belief quiver either did Uzbek hand unless year then numerous bread hour selfish.\",  \"id\": \"9d1b107b-c2bf-4b98-a156-6ee17ea0b427\",  \"keywords\": \"v4\",  \"price\": 266498.89,  \"url\": \"https://www.nationalincentivize.com/bleeding-edge/extend/24-7\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Entertainment",  "description": "That woman where smiling yearly till a poorly day abroad mob belief quiver either did Uzbek hand unless year then numerous bread hour selfish.",  "id": "9d1b107b-c2bf-4b98-a156-6ee17ea0b427",  "keywords": "v4",  "price": 266498.89,  "url": "https://www.nationalincentivize.com/bleeding-edge/extend/24-7"}"

```

```yaml
- text: "{ \"category\": \"Entertainment\", \"description\": \"That woman where smiling yearly till a poorly day abroad mob belief quiver either did Uzbek hand unless year then numerous bread hour selfish.\", \"id\": \"9d1b107b-c2bf-4b98-a156-6ee17ea0b427\", \"keywords\": \"v4\", \"price\": 266498.89, \"url\": \"https://www.nationalincentivize.com/bleeding-edge/extend/24-7\" }"
```
