...
Received string:  "{  \"category\": \"Biography\",  \"description\": \"Retire outdated person each quarter.\",  \"id\": \"2fdcb32a-cd3e-411a-be03-a2604ec8f518\",  \"price\": 282284.95,  \"subcategory\": \"wkfXBOvbpkGF\",  \"url\": \"http://www.operationssynergies.info/mesh/partnerships/extensible/granular\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Biography",  "description": "Retire outdated person each quarter.",  "id": "2fdcb32a-cd3e-411a-be03-a2604ec8f518",  "price": 282284.95,  "subcategory": "wkfXBOvbpkGF",  "url": "http://www.operationssynergies.info/mesh/partnerships/extensible/granular"}"

```

```yaml
- text: "{ \"category\": \"Biography\", \"description\": \"Retire outdated person each quarter.\", \"id\": \"2fdcb32a-cd3e-411a-be03-a2604ec8f518\", \"price\": 282284.95, \"subcategory\": \"wkfXBOvbpkGF\", \"url\": \"http://www.operationssynergies.info/mesh/partnerships/extensible/granular\" }"
```
