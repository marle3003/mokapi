...
Received string:  "{  \"category\": \"Art\",  \"description\": \"Yours child had ready for pain.\",  \"id\": \"d9130efb-f27f-4c40-9c78-656a82a0ddc3\",  \"keywords\": \"iKX2\",  \"name\": \"Amity\",  \"price\": 98393.08,  \"subcategory\": \"Nugg*Zx\",  \"url\": \"http://www.forwarddynamic.io/users/envisioneer/aggregate\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Art",  "description": "Yours child had ready for pain.",  "id": "d9130efb-f27f-4c40-9c78-656a82a0ddc3",  "keywords": "iKX2",  "name": "Amity",  "price": 98393.08,  "subcategory": "Nugg*Zx",  "url": "http://www.forwarddynamic.io/users/envisioneer/aggregate"}"

```

```yaml
- text: "{ \"category\": \"Art\", \"description\": \"Yours child had ready for pain.\", \"id\": \"d9130efb-f27f-4c40-9c78-656a82a0ddc3\", \"keywords\": \"iKX2\", \"name\": \"Amity\", \"price\": 98393.08, \"subcategory\": \"Nugg*Zx\", \"url\": \"http://www.forwarddynamic.io/users/envisioneer/aggregate\" }"
```
