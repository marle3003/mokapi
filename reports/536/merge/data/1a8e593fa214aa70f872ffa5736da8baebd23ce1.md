...
Received string:  "12345{  \"description\": \"E.g. retard some themselves care list the there according mine live dynasty watch any its knock finally whom been over weekly sit I why I those.\",  \"keywords\": \"L5Tho\",  \"price\": 619843.85}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 5 lines · 212 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 5"
                - text: "{ \"description\": \"E.g. retard some themselves care list the there according mine live dynasty watch any its knock finally whom been over weekly sit I why I those.\", \"keywords\": \"L5Tho\", \"price\": 619843.85 }"
            - status
            - button "Example"
            - button "Validate"
```
