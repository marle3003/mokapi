...
Expected string: "\"id\":"
Received string: "12345678{  \"category\": {    \"name\": \"turtle\"  },  \"name\": \"Biscuit\",  \"photoUrls\": [],  \"tags\": []}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
...
- main:
  ...
  - tabpanel " Body":
    ...
    - dialog "Data Validator":
      ...
      - button "Close"
      - region "Source":
        - text: application/json · 8 lines · 98 B
        - button "Copy raw content": 
        - button "Download raw content": 
        - region "Content":
          - textbox "Cursor at row 8"
          - text: "{ \"category\": { \"name\": \"turtle\" }, \"name\": \"Biscuit\", \"photoUrls\": [], \"tags\": [] }"
      - status
      - button "Example"
      - button "Validate"
  ...
  - tabpanel "200 OK":
    ...
    - tabpanel "Body":
      - region "Source":
        ...
        - region "Content":
          - textbox "Cursor at row 1"
          - text: "{ \"type\": [ \"object\" ], \"properties\": { \"tags\": { \"type\": \"array\", \"items\": { \"ref\": \"#/components/schemas/Tag\", \"type\": \"object\", \"properties\": { \"id\": { \"type\": \"integer\", \"format\": \"int64\" },"
      - button "Expand"
      - button "Example & Validate"
