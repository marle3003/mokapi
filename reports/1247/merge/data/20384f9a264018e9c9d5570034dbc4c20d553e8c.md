...
Received string:  "{  \"category\": \"Cloud\",  \"description\": \"Share the decision record for the thing.\",  \"id\": \"76d9351f-92b6-4d5d-84ca-b6481fac4185\",  \"keywords\": \"WuatYM2\",  \"name\": \"GroveGuard\",  \"subcategory\": \"ri \",  \"url\": \"https://www.divisionrelationships.name/deliverables\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Cloud",  "description": "Share the decision record for the thing.",  "id": "76d9351f-92b6-4d5d-84ca-b6481fac4185",  "keywords": "WuatYM2",  "name": "GroveGuard",  "subcategory": "ri ",  "url": "https://www.divisionrelationships.name/deliverables"}"

```

```yaml
- text: "{ \"category\": \"Cloud\", \"description\": \"Share the decision record for the thing.\", \"id\": \"76d9351f-92b6-4d5d-84ca-b6481fac4185\", \"keywords\": \"WuatYM2\", \"name\": \"GroveGuard\", \"subcategory\": \"ri \", \"url\": \"https://www.divisionrelationships.name/deliverables\" }"
```
