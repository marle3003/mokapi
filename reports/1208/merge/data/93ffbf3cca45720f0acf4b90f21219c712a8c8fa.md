...
Received string:  "{  \"category\": \"Action\",  \"description\": \"Publish a changelog entry for the life.\",  \"keywords\": \"zylQp#BfeTv\",  \"name\": \"Kin\",  \"price\": 289729.06,  \"subcategory\": \"rGwPySrppXvxxcq\",  \"url\": \"https://www.centralrevolutionary.net/leverage/interactive/roi/innovative\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Action",  "description": "Publish a changelog entry for the life.",  "keywords": "zylQp#BfeTv",  "name": "Kin",  "price": 289729.06,  "subcategory": "rGwPySrppXvxxcq",  "url": "https://www.centralrevolutionary.net/leverage/interactive/roi/innovative"}"

```

```yaml
- text: "{ \"category\": \"Action\", \"description\": \"Publish a changelog entry for the life.\", \"keywords\": \"zylQp#BfeTv\", \"name\": \"Kin\", \"price\": 289729.06, \"subcategory\": \"rGwPySrppXvxxcq\", \"url\": \"https://www.centralrevolutionary.net/leverage/interactive/roi/innovative\" }"
```
