...
Received string:  "{  \"category\": \"Gardening\",  \"description\": \"Your it be band these it this she tickle away you daily some why that fear microscope your her do meanwhile she this too reassure indeed.\",  \"id\": \"aa13ec38-07d4-4599-9e06-35e507d862be\",  \"name\": \"KarmaKey\",  \"price\": 441555.87,  \"subcategory\": \"\",  \"url\": \"https://www.nationaltransparent.biz/wireless/magnetic/interfaces/integrated\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Gardening",  "description": "Your it be band these it this she tickle away you daily some why that fear microscope your her do meanwhile she this too reassure indeed.",  "id": "aa13ec38-07d4-4599-9e06-35e507d862be",  "name": "KarmaKey",  "price": 441555.87,  "subcategory": "",  "url": "https://www.nationaltransparent.biz/wireless/magnetic/interfaces/integrated"}"

```

```yaml
- text: "{ \"category\": \"Gardening\", \"description\": \"Your it be band these it this she tickle away you daily some why that fear microscope your her do meanwhile she this too reassure indeed.\", \"id\": \"aa13ec38-07d4-4599-9e06-35e507d862be\", \"name\": \"KarmaKey\", \"price\": 441555.87, \"subcategory\": \"\", \"url\": \"https://www.nationaltransparent.biz/wireless/magnetic/interfaces/integrated\" }"
```
