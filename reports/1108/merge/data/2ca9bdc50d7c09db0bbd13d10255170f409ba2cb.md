...
Received string:  "{  \"category\": \"Sports\",  \"description\": \"Eventually, the year happen frankly.\",  \"id\": \"9db33c6f-6ca8-438a-b6b4-ff6ad51b0918\",  \"keywords\": \"a\",  \"name\": \"Zed\",  \"price\": 900776.11,  \"subcategory\": \"pVbaat\",  \"url\": \"http://www.executivenext-generation.net/communities/paradigms/embrace\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Sports",  "description": "Eventually, the year happen frankly.",  "id": "9db33c6f-6ca8-438a-b6b4-ff6ad51b0918",  "keywords": "a",  "name": "Zed",  "price": 900776.11,  "subcategory": "pVbaat",  "url": "http://www.executivenext-generation.net/communities/paradigms/embrace"}"

```

```yaml
- text: "{ \"category\": \"Sports\", \"description\": \"Eventually, the year happen frankly.\", \"id\": \"9db33c6f-6ca8-438a-b6b4-ff6ad51b0918\", \"keywords\": \"a\", \"name\": \"Zed\", \"price\": 900776.11, \"subcategory\": \"pVbaat\", \"url\": \"http://www.executivenext-generation.net/communities/paradigms/embrace\" }"
```
