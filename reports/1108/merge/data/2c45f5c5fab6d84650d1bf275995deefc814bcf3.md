...
Received string:  "{  \"category\": \"News\",  \"description\": \"Despite this, keep the life simple.\",  \"keywords\": \"wBhKuayd\",  \"name\": \"JadeVista\",  \"subcategory\": \"OBW\",  \"url\": \"https://www.regionalfacilitate.com/envisioneer\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "News",  "description": "Despite this, keep the life simple.",  "keywords": "wBhKuayd",  "name": "JadeVista",  "subcategory": "OBW",  "url": "https://www.regionalfacilitate.com/envisioneer"}"

```

```yaml
- text: "{ \"category\": \"News\", \"description\": \"Despite this, keep the life simple.\", \"keywords\": \"wBhKuayd\", \"name\": \"JadeVista\", \"subcategory\": \"OBW\", \"url\": \"https://www.regionalfacilitate.com/envisioneer\" }"
```
