...
Received string:  "{  \"category\": \"Data\",  \"description\": \"Establish a baseline for man.\",  \"keywords\": \"EiPjmw\",  \"name\": \"Amity\",  \"url\": \"https://www.regionalexpedite.org/incubate/orchestrate\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Data",  "description": "Establish a baseline for man.",  "keywords": "EiPjmw",  "name": "Amity",  "url": "https://www.regionalexpedite.org/incubate/orchestrate"}"

```

```yaml
- text: "{ \"category\": \"Data\", \"description\": \"Establish a baseline for man.\", \"keywords\": \"EiPjmw\", \"name\": \"Amity\", \"url\": \"https://www.regionalexpedite.org/incubate/orchestrate\" }"
```
