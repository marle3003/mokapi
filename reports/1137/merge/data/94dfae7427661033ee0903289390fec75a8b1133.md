...
Received string:  "{  \"category\": \"Literature\",  \"description\": \"Eventually, the hand limp hastily.\",  \"id\": \"d39ca6c3-034c-42e8-ba01-b8197c70fe8c\",  \"keywords\": \"LddYkSxnvbW\",  \"name\": \"ZenithLight\",  \"price\": 174229.24,  \"url\": \"https://www.internalenterprise.com/efficient/cultivate\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Literature",  "description": "Eventually, the hand limp hastily.",  "id": "d39ca6c3-034c-42e8-ba01-b8197c70fe8c",  "keywords": "LddYkSxnvbW",  "name": "ZenithLight",  "price": 174229.24,  "url": "https://www.internalenterprise.com/efficient/cultivate"}"

```

```yaml
- text: "{ \"category\": \"Literature\", \"description\": \"Eventually, the hand limp hastily.\", \"id\": \"d39ca6c3-034c-42e8-ba01-b8197c70fe8c\", \"keywords\": \"LddYkSxnvbW\", \"name\": \"ZenithLight\", \"price\": 174229.24, \"url\": \"https://www.internalenterprise.com/efficient/cultivate\" }"
```
