...
Received string:  "{  \"category\": \"Books\",  \"description\": \"Theirs year must ready for delay.\",  \"keywords\": \"D\",  \"name\": \"Evo\",  \"url\": \"http://www.productnetworks.info/enhance/scale\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Books",  "description": "Theirs year must ready for delay.",  "keywords": "D",  "name": "Evo",  "url": "http://www.productnetworks.info/enhance/scale"}"

```

```yaml
- text: "{ \"category\": \"Books\", \"description\": \"Theirs year must ready for delay.\", \"keywords\": \"D\", \"name\": \"Evo\", \"url\": \"http://www.productnetworks.info/enhance/scale\" }"
```
