...
Received string:  "{  \"category\": \"Beauty\",  \"id\": \"ca933e7f-5019-4900-bd63-47c25da942e1\",  \"keywords\": \"dphRgWUQlBcx\",  \"price\": 394595.96,  \"subcategory\": \"HLZN\",  \"url\": \"http://www.publicscale.io/seamless/communities\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Beauty",  "id": "ca933e7f-5019-4900-bd63-47c25da942e1",  "keywords": "dphRgWUQlBcx",  "price": 394595.96,  "subcategory": "HLZN",  "url": "http://www.publicscale.io/seamless/communities"}"

```

```yaml
- text: "{ \"category\": \"Beauty\", \"id\": \"ca933e7f-5019-4900-bd63-47c25da942e1\", \"keywords\": \"dphRgWUQlBcx\", \"price\": 394595.96, \"subcategory\": \"HLZN\", \"url\": \"http://www.publicscale.io/seamless/communities\" }"
```
