...
Received string:  "{  \"category\": \"Home & Garden\",  \"description\": \"As the suit, he clap punctually.\",  \"id\": \"4b113c68-609a-434c-8de7-80855e152d7d\",  \"keywords\": \"D\",  \"name\": \"KryptonGlow\",  \"price\": 244785.65,  \"url\": \"https://www.juniorsyndicate.info/synergize/e-services/scale/synthesize\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Home & Garden",  "description": "As the suit, he clap punctually.",  "id": "4b113c68-609a-434c-8de7-80855e152d7d",  "keywords": "D",  "name": "KryptonGlow",  "price": 244785.65,  "url": "https://www.juniorsyndicate.info/synergize/e-services/scale/synthesize"}"

```

```yaml
- text: "{ \"category\": \"Home & Garden\", \"description\": \"As the suit, he clap punctually.\", \"id\": \"4b113c68-609a-434c-8de7-80855e152d7d\", \"keywords\": \"D\", \"name\": \"KryptonGlow\", \"price\": 244785.65, \"url\": \"https://www.juniorsyndicate.info/synergize/e-services/scale/synthesize\" }"
```
