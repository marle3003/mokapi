...
Received string:  "{  \"category\": \"Literature\",  \"description\": \"Continuously measure the woman and insert the outliers.\",  \"id\": \"fbfc7faf-1ec4-424f-8a6d-441a43208eae\",  \"keywords\": \"KRF\",  \"name\": \"Prism\",  \"subcategory\": \"byqYcGNByxa\",  \"url\": \"https://www.staffinnovate.name/facilitate\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Literature",  "description": "Continuously measure the woman and insert the outliers.",  "id": "fbfc7faf-1ec4-424f-8a6d-441a43208eae",  "keywords": "KRF",  "name": "Prism",  "subcategory": "byqYcGNByxa",  "url": "https://www.staffinnovate.name/facilitate"}"

```

```yaml
- text: "{ \"category\": \"Literature\", \"description\": \"Continuously measure the woman and insert the outliers.\", \"id\": \"fbfc7faf-1ec4-424f-8a6d-441a43208eae\", \"keywords\": \"KRF\", \"name\": \"Prism\", \"subcategory\": \"byqYcGNByxa\", \"url\": \"https://www.staffinnovate.name/facilitate\" }"
```
