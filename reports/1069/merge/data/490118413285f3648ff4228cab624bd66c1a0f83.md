...
Received string:  "{  \"category\": \"Game\",  \"description\": \"Archive stale woman responsibly.\",  \"id\": \"dc1ffc09-6bb7-4fb0-96bd-aa42b35a0044\",  \"keywords\": \"iyT2uymJh9lF\",  \"price\": 86071.1,  \"subcategory\": \"W_lRheW\",  \"url\": \"https://www.juniortransparent.com/functionalities\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Game",  "description": "Archive stale woman responsibly.",  "id": "dc1ffc09-6bb7-4fb0-96bd-aa42b35a0044",  "keywords": "iyT2uymJh9lF",  "price": 86071.1,  "subcategory": "W_lRheW",  "url": "https://www.juniortransparent.com/functionalities"}"

```

```yaml
- text: "{ \"category\": \"Game\", \"description\": \"Archive stale woman responsibly.\", \"id\": \"dc1ffc09-6bb7-4fb0-96bd-aa42b35a0044\", \"keywords\": \"iyT2uymJh9lF\", \"price\": 86071.1, \"subcategory\": \"W_lRheW\", \"url\": \"https://www.juniortransparent.com/functionalities\" }"
```
