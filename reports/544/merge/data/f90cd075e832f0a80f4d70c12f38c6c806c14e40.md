...
Received string:  "{  \"category\": \"Fantasy\",  \"description\": \"From dynasty eye even ourselves your forest grip that whichever up madly host now phew whoever alas adult whose who of oxygen this where.\",  \"id\": \"7f83799e-7da4-4bb9-804b-72c80106051c\",  \"keywords\": \"J\",  \"name\": \"Utopia\",  \"subcategory\": \"q\",  \"url\": \"http://www.dynamicsynergize.com/unleash\"}"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    9 × locator resolved to <div class="ace_content">…</div>
      - unexpected value "{  "category": "Fantasy",  "description": "From dynasty eye even ourselves your forest grip that whichever up madly host now phew whoever alas adult whose who of oxygen this where.",  "id": "7f83799e-7da4-4bb9-804b-72c80106051c",  "keywords": "J",  "name": "Utopia",  "subcategory": "q",  "url": "http://www.dynamicsynergize.com/unleash"}"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 9 lines · 346 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 9"
                - text: "{ \"category\": \"Fantasy\", \"description\": \"From dynasty eye even ourselves your forest grip that whichever up madly host now phew whoever alas adult whose who of oxygen this where.\", \"id\": \"7f83799e-7da4-4bb9-804b-72c80106051c\", \"keywords\": \"J\", \"name\": \"Utopia\", \"subcategory\": \"q\", \"url\": \"http://www.dynamicsynergize.com/unleash\" }"
            - status
            - button "Example"
            - button "Validate"
```
...
index 6aaf798c..3f91073e 100644
...
index 35af48b2..d19697ff 100644
