...
Received string:  "{  \"category\": \"Design\",  \"description\": \"Attribute gains to woman where possible.\",  \"id\": \"fe4d4656-b9a4-4c39-9401-611a18ff3729\",  \"keywords\": \"i2vHbS\",  \"name\": \"Stellar\",  \"price\": 497130.08,  \"url\": \"http://www.seniorunleash.info/deliverables/front-end/integrated\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Design",  "description": "Attribute gains to woman where possible.",  "id": "fe4d4656-b9a4-4c39-9401-611a18ff3729",  "keywords": "i2vHbS",  "name": "Stellar",  "price": 497130.08,  "url": "http://www.seniorunleash.info/deliverables/front-end/integrated"}"

```

```yaml
- text: "{ \"category\": \"Design\", \"description\": \"Attribute gains to woman where possible.\", \"id\": \"fe4d4656-b9a4-4c39-9401-611a18ff3729\", \"keywords\": \"i2vHbS\", \"name\": \"Stellar\", \"price\": 497130.08, \"url\": \"http://www.seniorunleash.info/deliverables/front-end/integrated\" }"
```
