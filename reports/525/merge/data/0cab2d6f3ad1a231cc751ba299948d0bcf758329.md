...
Expected string: "\"id\":"
Received string: "12345678910{  \"photoUrls\": [    \"https://www.regionale-business.com/bandwidth/24-365/benchmark/synthesize\",    \"https://www.regionalmodels.biz/next-generation\",    \"https://www.regionalviral.info/clicks-and-mortar/brand/markets\",    \"http://www.seniorinnovative.name/grow\",    \"https://www.internalimplement.net/functionalities/schemas/aggregate\"  ],  \"status\": \"pending\"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
  ...
  - waiting for locator('main').getByTestId('http-operation').getByTestId('http-request').getByRole('dialog', { name: 'Data Validator' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'Content' })
    9 × locator resolved to <section data-v-4320bd73="" class="source json" aria-label="Content">…</section>
      - unexpected value "12345678910{  "photoUrls": [    "https://www.regionale-business.com/bandwidth/24-365/benchmark/synthesize",    "https://www.regionalmodels.biz/next-generation",    "https://www.regionalviral.info/clicks-and-mortar/brand/markets",    "http://www.seniorinnovative.name/grow",    "https://www.internalimplement.net/functionalities/schemas/aggregate"  ],  "status": "pending"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
...
- main:
  ...
  - tabpanel " Body":
    ...
    - dialog "Data Validator":
      ...
      - button "Close"
      - region "Source":
        - text: application/json · 10 lines · 370 B
        - button "Copy raw content": 
        - button "Download raw content": 
        - region "Content":
          - textbox "Cursor at row 10"
          - text: "{ \"photoUrls\": [ \"https://www.regionale-business.com/bandwidth/24-365/benchmark/synthesize\", \"https://www.regionalmodels.biz/next-generation\", \"https://www.regionalviral.info/clicks-and-mortar/brand/markets\", \"http://www.seniorinnovative.name/grow\", \"https://www.internalimplement.net/functionalities/schemas/aggregate\" ], \"status\": \"pending\" }"
      - status
      - button "Example"
      - button "Validate"
...
index c24bc726..c59730c3 100644
...
index b54f03a8..85ced33b 100644
