...
Received string:  "1234567{  \"category\": \"News\",  \"description\": \"Has can whose that my never day as adult as meanwhile whichever woman could company Guyanese above smell everything win all your to she monthly some.\",  \"id\": \"ccecf854-7734-4b68-af3c-196c03de8a8f\",  \"name\": \"Halo\",  \"url\": \"https://www.producte-business.biz/reintermediate/extensible\"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' })
    9 × locator resolved to <section data-v-4320bd73="" class="source json" aria-label="Content">…</section>
      - unexpected value "1234567{  "category": "News",  "description": "Has can whose that my never day as adult as meanwhile whichever woman could company Guyanese above smell everything win all your to she monthly some.",  "id": "ccecf854-7734-4b68-af3c-196c03de8a8f",  "name": "Halo",  "url": "https://www.producte-business.biz/reintermediate/extensible"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 7 lines · 332 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 7"
                - text: "{ \"category\": \"News\", \"description\": \"Has can whose that my never day as adult as meanwhile whichever woman could company Guyanese above smell everything win all your to she monthly some.\", \"id\": \"ccecf854-7734-4b68-af3c-196c03de8a8f\", \"name\": \"Halo\", \"url\": \"https://www.producte-business.biz/reintermediate/extensible\" }"
            - status
            - button "Example"
            - button "Validate"
```
