...
Received string:  "{  \"category\": \"Pets\",  \"description\": \"Launch the number midweek for clarity.\",  \"id\": \"6ecc0caf-9a03-4b77-bbc6-b50866a9a69d\",  \"keywords\": \"vF\",  \"price\": 335327.26,  \"url\": \"http://www.headseamless.io/sexy\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Pets",  "description": "Launch the number midweek for clarity.",  "id": "6ecc0caf-9a03-4b77-bbc6-b50866a9a69d",  "keywords": "vF",  "price": 335327.26,  "url": "http://www.headseamless.io/sexy"}"

```

```yaml
- text: "{ \"category\": \"Pets\", \"description\": \"Launch the number midweek for clarity.\", \"id\": \"6ecc0caf-9a03-4b77-bbc6-b50866a9a69d\", \"keywords\": \"vF\", \"price\": 335327.26, \"url\": \"http://www.headseamless.io/sexy\" }"
```
