...
Received string:  "{  \"category\": \"Health\",  \"description\": \"Close the loop on the number.\",  \"id\": \"504559c2-89ab-45ad-ae9b-430b39942abc\",  \"name\": \"LumenHaven\",  \"price\": 772858.67,  \"subcategory\": \"7zukod7Rd7Qmrg\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Health",  "description": "Close the loop on the number.",  "id": "504559c2-89ab-45ad-ae9b-430b39942abc",  "name": "LumenHaven",  "price": 772858.67,  "subcategory": "7zukod7Rd7Qmrg"}"

```

```yaml
- text: "{ \"category\": \"Health\", \"description\": \"Close the loop on the number.\", \"id\": \"504559c2-89ab-45ad-ae9b-430b39942abc\", \"name\": \"LumenHaven\", \"price\": 772858.67, \"subcategory\": \"7zukod7Rd7Qmrg\" }"
```
