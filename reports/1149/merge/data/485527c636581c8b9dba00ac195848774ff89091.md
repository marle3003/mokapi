...
Received string:  "{  \"category\": \"Fantasy\",  \"id\": \"a5a484d2-28e6-4bec-b389-1ca89497e666\",  \"keywords\": \"Sznc h<FA7Z72\",  \"name\": \"Prism\",  \"price\": 606735.81,  \"subcategory\": \"r\",  \"url\": \"https://www.headarchitectures.org/cross-media\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Fantasy",  "id": "a5a484d2-28e6-4bec-b389-1ca89497e666",  "keywords": "Sznc h<FA7Z72",  "name": "Prism",  "price": 606735.81,  "subcategory": "r",  "url": "https://www.headarchitectures.org/cross-media"}"

```

```yaml
- text: "{ \"category\": \"Fantasy\", \"id\": \"a5a484d2-28e6-4bec-b389-1ca89497e666\", \"keywords\": \"Sznc h<FA7Z72\", \"name\": \"Prism\", \"price\": 606735.81, \"subcategory\": \"r\", \"url\": \"https://www.headarchitectures.org/cross-media\" }"
```
