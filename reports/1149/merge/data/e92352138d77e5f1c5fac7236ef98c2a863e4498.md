...
Received string:  "{  \"category\": \"Game\",  \"description\": \"Optimize part for quizzical clarity.\",  \"id\": \"4772f597-0bde-4e76-86ba-62e3fcbcc9bf\",  \"keywords\": \"RRsdp\",  \"name\": \"JadeVoyage\",  \"price\": 280251.36,  \"subcategory\": \"ss\",  \"url\": \"http://www.marketingarchitect.org/24-7\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Game",  "description": "Optimize part for quizzical clarity.",  "id": "4772f597-0bde-4e76-86ba-62e3fcbcc9bf",  "keywords": "RRsdp",  "name": "JadeVoyage",  "price": 280251.36,  "subcategory": "ss",  "url": "http://www.marketingarchitect.org/24-7"}"

```

```yaml
- text: "{ \"category\": \"Game\", \"description\": \"Optimize part for quizzical clarity.\", \"id\": \"4772f597-0bde-4e76-86ba-62e3fcbcc9bf\", \"keywords\": \"RRsdp\", \"name\": \"JadeVoyage\", \"price\": 280251.36, \"subcategory\": \"ss\", \"url\": \"http://www.marketingarchitect.org/24-7\" }"
```
