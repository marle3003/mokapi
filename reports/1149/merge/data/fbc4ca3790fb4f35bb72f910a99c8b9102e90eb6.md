...
Received string:  "{  \"category\": \"Religion\",  \"description\": \"Hers fact will ready for timing.\",  \"keywords\": \"3qDEfCevGkjJ\",  \"name\": \"RippleZone\",  \"price\": 582971.22,  \"subcategory\": \"5wsLg\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Religion",  "description": "Hers fact will ready for timing.",  "keywords": "3qDEfCevGkjJ",  "name": "RippleZone",  "price": 582971.22,  "subcategory": "5wsLg"}"

```

```yaml
- text: "{ \"category\": \"Religion\", \"description\": \"Hers fact will ready for timing.\", \"keywords\": \"3qDEfCevGkjJ\", \"name\": \"RippleZone\", \"price\": 582971.22, \"subcategory\": \"5wsLg\" }"
```
