...
Received string:  "{  \"category\": \"Fantasy\",  \"description\": \"Ruthlessly remove dead year.\",  \"id\": \"31e9362b-d598-4f90-ba61-b708657fc6b5\",  \"keywords\": \"\",  \"name\": \"TerraTrove\",  \"price\": 399674.85,  \"subcategory\": \"mxivyz BE\",  \"url\": \"http://www.internalincentivize.com/architect/e-commerce\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Fantasy",  "description": "Ruthlessly remove dead year.",  "id": "31e9362b-d598-4f90-ba61-b708657fc6b5",  "keywords": "",  "name": "TerraTrove",  "price": 399674.85,  "subcategory": "mxivyz BE",  "url": "http://www.internalincentivize.com/architect/e-commerce"}"

```

```yaml
- text: "{ \"category\": \"Fantasy\", \"description\": \"Ruthlessly remove dead year.\", \"id\": \"31e9362b-d598-4f90-ba61-b708657fc6b5\", \"keywords\": \"\", \"name\": \"TerraTrove\", \"price\": 399674.85, \"subcategory\": \"mxivyz BE\", \"url\": \"http://www.internalincentivize.com/architect/e-commerce\" }"
```
