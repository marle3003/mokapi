...
Received string:  "{  \"category\": \"Architecture\",  \"description\": \"Practice part drills regularly.\",  \"id\": \"465140b7-2ac7-42a8-8800-fc938ef6b46e\",  \"name\": \"VortexEdge\",  \"price\": 957065.27,  \"subcategory\": \"Vhm\",  \"url\": \"https://www.internationalout-of-the-box.name/reinvent/cross-platform\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Architecture",  "description": "Practice part drills regularly.",  "id": "465140b7-2ac7-42a8-8800-fc938ef6b46e",  "name": "VortexEdge",  "price": 957065.27,  "subcategory": "Vhm",  "url": "https://www.internationalout-of-the-box.name/reinvent/cross-platform"}"

```

```yaml
- text: "{ \"category\": \"Architecture\", \"description\": \"Practice part drills regularly.\", \"id\": \"465140b7-2ac7-42a8-8800-fc938ef6b46e\", \"name\": \"VortexEdge\", \"price\": 957065.27, \"subcategory\": \"Vhm\", \"url\": \"https://www.internationalout-of-the-box.name/reinvent/cross-platform\" }"
```
