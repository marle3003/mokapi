...
Received string:  "{  \"category\": \"Fantasy\",  \"description\": \"Before launch, she cook today.\",  \"id\": \"c6c15922-0ac7-4ad7-bdb4-144262c171c1\",  \"keywords\": \"fh l\",  \"price\": 298739.44,  \"url\": \"https://www.humandisintermediate.com/synergies/extend/global/recontextualize\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Fantasy",  "description": "Before launch, she cook today.",  "id": "c6c15922-0ac7-4ad7-bdb4-144262c171c1",  "keywords": "fh l",  "price": 298739.44,  "url": "https://www.humandisintermediate.com/synergies/extend/global/recontextualize"}"

```

```yaml
- text: "{ \"category\": \"Fantasy\", \"description\": \"Before launch, she cook today.\", \"id\": \"c6c15922-0ac7-4ad7-bdb4-144262c171c1\", \"keywords\": \"fh l\", \"price\": 298739.44, \"url\": \"https://www.humandisintermediate.com/synergies/extend/global/recontextualize\" }"
```
