...
Received string:  "{  \"category\": \"Garden\",  \"description\": \"After 2 iterations, they load the company violently.\",  \"id\": \"d6e93503-248e-49da-81d0-9affa1ec13ff\",  \"keywords\": \"Ng\",  \"price\": 662496.76,  \"url\": \"https://www.corporateb2b.org/exploit/embrace/users\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Garden",  "description": "After 2 iterations, they load the company violently.",  "id": "d6e93503-248e-49da-81d0-9affa1ec13ff",  "keywords": "Ng",  "price": 662496.76,  "url": "https://www.corporateb2b.org/exploit/embrace/users"}"

```

```yaml
- text: "{ \"category\": \"Garden\", \"description\": \"After 2 iterations, they load the company violently.\", \"id\": \"d6e93503-248e-49da-81d0-9affa1ec13ff\", \"keywords\": \"Ng\", \"price\": 662496.76, \"url\": \"https://www.corporateb2b.org/exploit/embrace/users\" }"
```
