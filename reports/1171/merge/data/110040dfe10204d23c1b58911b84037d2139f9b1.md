...
Received string:  "{  \"description\": \"Durable time being worth the joy.\",  \"id\": \"ea32ba19-f585-449b-935b-4f7ca4301010\",  \"keywords\": \"misSMbClFSK\",  \"name\": \"NovaLink\",  \"price\": 822239.64,  \"subcategory\": \"RnxrTbofc;kvkA\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "description": "Durable time being worth the joy.",  "id": "ea32ba19-f585-449b-935b-4f7ca4301010",  "keywords": "misSMbClFSK",  "name": "NovaLink",  "price": 822239.64,  "subcategory": "RnxrTbofc;kvkA"}"

```

```yaml
- text: "{ \"description\": \"Durable time being worth the joy.\", \"id\": \"ea32ba19-f585-449b-935b-4f7ca4301010\", \"keywords\": \"misSMbClFSK\", \"name\": \"NovaLink\", \"price\": 822239.64, \"subcategory\": \"RnxrTbofc;kvkA\" }"
```
