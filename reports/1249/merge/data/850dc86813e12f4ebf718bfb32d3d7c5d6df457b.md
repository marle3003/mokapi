...
Received string:  "{  \"category\": \"Music\",  \"description\": \"Explicitly name the year before you vilify it.\",  \"id\": \"4251949f-0d77-44f3-8f59-a8b8f36b43c4\",  \"keywords\": \"pDI0hvyxFQ\",  \"name\": \"Sky\",  \"price\": 642132.44}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Music",  "description": "Explicitly name the year before you vilify it.",  "id": "4251949f-0d77-44f3-8f59-a8b8f36b43c4",  "keywords": "pDI0hvyxFQ",  "name": "Sky",  "price": 642132.44}"

```

```yaml
- text: "{ \"category\": \"Music\", \"description\": \"Explicitly name the year before you vilify it.\", \"id\": \"4251949f-0d77-44f3-8f59-a8b8f36b43c4\", \"keywords\": \"pDI0hvyxFQ\", \"name\": \"Sky\", \"price\": 642132.44 }"
```
