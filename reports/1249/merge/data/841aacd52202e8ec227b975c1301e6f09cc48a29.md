...
Received string:  "{  \"category\": \"Work\",  \"keywords\": \"qQft\",  \"name\": \"Sync\",  \"url\": \"http://www.divisionbleeding-edge.biz/eyeballs/b2c/deploy\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Work",  "keywords": "qQft",  "name": "Sync",  "url": "http://www.divisionbleeding-edge.biz/eyeballs/b2c/deploy"}"

```

```yaml
- text: "{ \"category\": \"Work\", \"keywords\": \"qQft\", \"name\": \"Sync\", \"url\": \"http://www.divisionbleeding-edge.biz/eyeballs/b2c/deploy\" }"
```
