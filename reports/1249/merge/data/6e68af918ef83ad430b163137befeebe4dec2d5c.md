...
Received string:  "{  \"category\": \"Business\",  \"description\": \"Ours week could ready for kindness.\",  \"id\": \"4900a6e8-2a21-458c-993e-f8462f3916f3\",  \"keywords\": \"CDG9\",  \"name\": \"Comet\",  \"price\": 254043.59,  \"subcategory\": \"Xm\",  \"url\": \"https://www.operationsglobal.org/communities/open-source\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Business",  "description": "Ours week could ready for kindness.",  "id": "4900a6e8-2a21-458c-993e-f8462f3916f3",  "keywords": "CDG9",  "name": "Comet",  "price": 254043.59,  "subcategory": "Xm",  "url": "https://www.operationsglobal.org/communities/open-source"}"

```

```yaml
- text: "{ \"category\": \"Business\", \"description\": \"Ours week could ready for kindness.\", \"id\": \"4900a6e8-2a21-458c-993e-f8462f3916f3\", \"keywords\": \"CDG9\", \"name\": \"Comet\", \"price\": 254043.59, \"subcategory\": \"Xm\", \"url\": \"https://www.operationsglobal.org/communities/open-source\" }"
```
