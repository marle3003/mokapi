...
Call log:
  - Expect "toHaveText" getByRole('region', { name: 'Dashboard' }).getByRole('region', { name: 'Content' }).getByRole('region', { name: 'Source' }).getByLabel('Lines of Code') with timeout 5000ms
  - waiting for getByRole('region', { name: 'Dashboard' }).getByRole('region', { name: 'Content' }).getByRole('region', { name: 'Source' }).getByLabel('Lines of Code')
    14 × locator resolved to <span data-v-6bec6577="" aria-label="Lines of Code">1 lines</span>
