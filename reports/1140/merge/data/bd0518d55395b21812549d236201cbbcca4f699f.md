...
Received string:  "{  \"category\": \"Environment\",  \"description\": \"Guide problem with improvised affordances.\",  \"id\": \"341ca8ca-b6e3-454f-9ae2-4d79fde55cb5\",  \"keywords\": \"knSmf\",  \"name\": \"JasperJunction\",  \"subcategory\": \"QAJi5SJPqJb\",  \"url\": \"http://www.headdeliver.net/cutting-edge\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Environment",  "description": "Guide problem with improvised affordances.",  "id": "341ca8ca-b6e3-454f-9ae2-4d79fde55cb5",  "keywords": "knSmf",  "name": "JasperJunction",  "subcategory": "QAJi5SJPqJb",  "url": "http://www.headdeliver.net/cutting-edge"}"

```

```yaml
- text: "{ \"category\": \"Environment\", \"description\": \"Guide problem with improvised affordances.\", \"id\": \"341ca8ca-b6e3-454f-9ae2-4d79fde55cb5\", \"keywords\": \"knSmf\", \"name\": \"JasperJunction\", \"subcategory\": \"QAJi5SJPqJb\", \"url\": \"http://www.headdeliver.net/cutting-edge\" }"
```
