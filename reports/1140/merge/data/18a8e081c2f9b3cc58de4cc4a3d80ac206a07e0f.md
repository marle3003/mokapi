...
Received string:  "{  \"category\": \"Horror\",  \"description\": \"Budget latency for eye.\",  \"id\": \"2062fb30-6703-4fcf-a909-bfdc59346c45\",  \"keywords\": \"EVhlttqxcgTszc\",  \"name\": \"BlazeCraft\",  \"price\": 956266.9,  \"subcategory\": \"Qt\",  \"url\": \"http://www.chiefimpactful.com/experiences/one-to-one\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Horror",  "description": "Budget latency for eye.",  "id": "2062fb30-6703-4fcf-a909-bfdc59346c45",  "keywords": "EVhlttqxcgTszc",  "name": "BlazeCraft",  "price": 956266.9,  "subcategory": "Qt",  "url": "http://www.chiefimpactful.com/experiences/one-to-one"}"

```

```yaml
- text: "{ \"category\": \"Horror\", \"description\": \"Budget latency for eye.\", \"id\": \"2062fb30-6703-4fcf-a909-bfdc59346c45\", \"keywords\": \"EVhlttqxcgTszc\", \"name\": \"BlazeCraft\", \"price\": 956266.9, \"subcategory\": \"Qt\", \"url\": \"http://www.chiefimpactful.com/experiences/one-to-one\" }"
```
