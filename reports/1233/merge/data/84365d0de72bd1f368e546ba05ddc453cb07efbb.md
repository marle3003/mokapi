...
Received string:  "{  \"description\": \"Automate man recovery inadequately.\",  \"id\": \"fd911a9f-b1ce-4814-9431-dd504aeb2730\",  \"keywords\": \"eanaNqmkTMgbUi\",  \"name\": \"Zed\",  \"price\": 155079,  \"url\": \"https://www.dynamicrich.biz/e-business/users\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "description": "Automate man recovery inadequately.",  "id": "fd911a9f-b1ce-4814-9431-dd504aeb2730",  "keywords": "eanaNqmkTMgbUi",  "name": "Zed",  "price": 155079,  "url": "https://www.dynamicrich.biz/e-business/users"}"

```

```yaml
- text: "{ \"description\": \"Automate man recovery inadequately.\", \"id\": \"fd911a9f-b1ce-4814-9431-dd504aeb2730\", \"keywords\": \"eanaNqmkTMgbUi\", \"name\": \"Zed\", \"price\": 155079, \"url\": \"https://www.dynamicrich.biz/e-business/users\" }"
```
