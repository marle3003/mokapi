...
Received string:  "{  \"category\": \"Action\",  \"description\": \"As how myself them himself upstairs yay had whose arrow consequence everybody yours previously nobody swim who by until hey open well other across.\",  \"id\": \"8b0a26e7-5f54-45c4-9673-5d85788d4fdf\",  \"keywords\": \"AjnsYgv8lRW\",  \"name\": \"Velvet\",  \"price\": 232634.18,  \"subcategory\": \"TTEcAyFUlCIr\",  \"url\": \"https://www.regionalb2c.info/vertical\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Action",  "description": "As how myself them himself upstairs yay had whose arrow consequence everybody yours previously nobody swim who by until hey open well other across.",  "id": "8b0a26e7-5f54-45c4-9673-5d85788d4fdf",  "keywords": "AjnsYgv8lRW",  "name": "Velvet",  "price": 232634.18,  "subcategory": "TTEcAyFUlCIr",  "url": "https://www.regionalb2c.info/vertical"}"

```

```yaml
- text: "{ \"category\": \"Action\", \"description\": \"As how myself them himself upstairs yay had whose arrow consequence everybody yours previously nobody swim who by until hey open well other across.\", \"id\": \"8b0a26e7-5f54-45c4-9673-5d85788d4fdf\", \"keywords\": \"AjnsYgv8lRW\", \"name\": \"Velvet\", \"price\": 232634.18, \"subcategory\": \"TTEcAyFUlCIr\", \"url\": \"https://www.regionalb2c.info/vertical\" }"
```
