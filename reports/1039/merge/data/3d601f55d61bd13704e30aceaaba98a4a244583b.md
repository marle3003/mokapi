...
Received string:  "{  \"description\": \"Fight no me on his regularly in over another tomorrow consequently of on shall your hers in hey that try hmm such has how inexpensive daily.\",  \"keywords\": \"ptd\",  \"name\": \"TideTreasure\",  \"subcategory\": \"deugGWGT\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "description": "Fight no me on his regularly in over another tomorrow consequently of on shall your hers in hey that try hmm such has how inexpensive daily.",  "keywords": "ptd",  "name": "TideTreasure",  "subcategory": "deugGWGT"}"

```

```yaml
- text: "{ \"description\": \"Fight no me on his regularly in over another tomorrow consequently of on shall your hers in hey that try hmm such has how inexpensive daily.\", \"keywords\": \"ptd\", \"name\": \"TideTreasure\", \"subcategory\": \"deugGWGT\" }"
```
