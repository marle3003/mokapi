...
Received string:  "{  \"category\": \"Health\",  \"description\": \"Deliberately select the number.\",  \"id\": \"84ba00bc-6a0b-43c6-ab10-f922c1d82ece\",  \"keywords\": \"uZhLQkSex\",  \"name\": \"UmbraPhase\",  \"price\": 762518.07,  \"subcategory\": \"TuHI nrdxi\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Health",  "description": "Deliberately select the number.",  "id": "84ba00bc-6a0b-43c6-ab10-f922c1d82ece",  "keywords": "uZhLQkSex",  "name": "UmbraPhase",  "price": 762518.07,  "subcategory": "TuHI nrdxi"}"

```

```yaml
- text: "{ \"category\": \"Health\", \"description\": \"Deliberately select the number.\", \"id\": \"84ba00bc-6a0b-43c6-ab10-f922c1d82ece\", \"keywords\": \"uZhLQkSex\", \"name\": \"UmbraPhase\", \"price\": 762518.07, \"subcategory\": \"TuHI nrdxi\" }"
```
