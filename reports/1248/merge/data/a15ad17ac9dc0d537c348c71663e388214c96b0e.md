...
Received string:  "{  \"category\": \"Food\",  \"description\": \"Defer point during peak load.\",  \"id\": \"3517e08b-d951-41ed-a796-0b02a05fd793\",  \"keywords\": \"y\",  \"name\": \"PrismPulse\",  \"subcategory\": \"SWWgnQNAZj\",  \"url\": \"https://www.customerinterfaces.net/eyeballs/proactive/wireless\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Food",  "description": "Defer point during peak load.",  "id": "3517e08b-d951-41ed-a796-0b02a05fd793",  "keywords": "y",  "name": "PrismPulse",  "subcategory": "SWWgnQNAZj",  "url": "https://www.customerinterfaces.net/eyeballs/proactive/wireless"}"

```

```yaml
- text: "{ \"category\": \"Food\", \"description\": \"Defer point during peak load.\", \"id\": \"3517e08b-d951-41ed-a796-0b02a05fd793\", \"keywords\": \"y\", \"name\": \"PrismPulse\", \"subcategory\": \"SWWgnQNAZj\", \"url\": \"https://www.customerinterfaces.net/eyeballs/proactive/wireless\" }"
```
