...
Received string:  "{  \"category\": \"Self-Help\",  \"description\": \"Clarify ownership of the company already.\",  \"id\": \"da58c177-44d6-4a2e-a56b-c6bdf59d0a74\",  \"name\": \"KaleidoSky\",  \"price\": 668890.07,  \"subcategory\": \"xsgFWE8Mi\",  \"url\": \"http://www.humanviral.name/leading-edge\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Self-Help",  "description": "Clarify ownership of the company already.",  "id": "da58c177-44d6-4a2e-a56b-c6bdf59d0a74",  "name": "KaleidoSky",  "price": 668890.07,  "subcategory": "xsgFWE8Mi",  "url": "http://www.humanviral.name/leading-edge"}"

```

```yaml
- text: "{ \"category\": \"Self-Help\", \"description\": \"Clarify ownership of the company already.\", \"id\": \"da58c177-44d6-4a2e-a56b-c6bdf59d0a74\", \"name\": \"KaleidoSky\", \"price\": 668890.07, \"subcategory\": \"xsgFWE8Mi\", \"url\": \"http://www.humanviral.name/leading-edge\" }"
```
