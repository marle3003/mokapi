...
Received string:  "{  \"category\": \"DIY\",  \"description\": \"Choose funny defaults.\",  \"id\": \"a6cef5fc-fcd9-471a-bbdb-fe9b184dd13c\",  \"keywords\": \"eQfuBrJMynTWx\",  \"name\": \"UmbraPhase\",  \"price\": 578525.67,  \"subcategory\": \"DJjd\",  \"url\": \"https://www.businessturn-key.io/target\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "DIY",  "description": "Choose funny defaults.",  "id": "a6cef5fc-fcd9-471a-bbdb-fe9b184dd13c",  "keywords": "eQfuBrJMynTWx",  "name": "UmbraPhase",  "price": 578525.67,  "subcategory": "DJjd",  "url": "https://www.businessturn-key.io/target"}"

```

```yaml
- text: "{ \"category\": \"DIY\", \"description\": \"Choose funny defaults.\", \"id\": \"a6cef5fc-fcd9-471a-bbdb-fe9b184dd13c\", \"keywords\": \"eQfuBrJMynTWx\", \"name\": \"UmbraPhase\", \"price\": 578525.67, \"subcategory\": \"DJjd\", \"url\": \"https://www.businessturn-key.io/target\" }"
```
