...
Received string:  "{  \"id\": \"58c613ca-6e6d-4650-9819-43fa07d96fff\",  \"keywords\": \"EtpWubuFnf\",  \"name\": \"RavenRoost\",  \"price\": 586789.63,  \"subcategory\": \"hdSw cDY\",  \"url\": \"http://www.groupincentivize.org/vortals/maximize/redefine/experiences\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "id": "58c613ca-6e6d-4650-9819-43fa07d96fff",  "keywords": "EtpWubuFnf",  "name": "RavenRoost",  "price": 586789.63,  "subcategory": "hdSw cDY",  "url": "http://www.groupincentivize.org/vortals/maximize/redefine/experiences"}"

```

```yaml
- text: "{ \"id\": \"58c613ca-6e6d-4650-9819-43fa07d96fff\", \"keywords\": \"EtpWubuFnf\", \"name\": \"RavenRoost\", \"price\": 586789.63, \"subcategory\": \"hdSw cDY\", \"url\": \"http://www.groupincentivize.org/vortals/maximize/redefine/experiences\" }"
```
