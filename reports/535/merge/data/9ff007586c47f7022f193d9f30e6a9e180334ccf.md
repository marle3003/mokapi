...
Received string:  "12345678{  \"category\": \"Technology\",  \"description\": \"Over skip which in each bale over turn that just to why nearby fact its were firstly hers may anyone a sand patiently who clever yourself.\",  \"name\": \"Velvet\",  \"price\": 19707.8,  \"subcategory\": \"CIqGhjcmSQ\",  \"url\": \"http://www.internationalmarkets.net/unleash/relationships\"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' })
    9 × locator resolved to <section data-v-4320bd73="" class="source json" aria-label="Content">…</section>
      - unexpected value "12345678{  "category": "Technology",  "description": "Over skip which in each bale over turn that just to why nearby fact its were firstly hers may anyone a sand patiently who clever yourself.",  "name": "Velvet",  "price": 19707.8,  "subcategory": "CIqGhjcmSQ",  "url": "http://www.internationalmarkets.net/unleash/relationships"}  הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 8 lines · 330 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 8"
                - text: "{ \"category\": \"Technology\", \"description\": \"Over skip which in each bale over turn that just to why nearby fact its were firstly hers may anyone a sand patiently who clever yourself.\", \"name\": \"Velvet\", \"price\": 19707.8, \"subcategory\": \"CIqGhjcmSQ\", \"url\": \"http://www.internationalmarkets.net/unleash/relationships\" }"
            - status
            - button "Example"
            - button "Validate"
```
...
index 3b196678..f31894ed 100644
...
index 2be24f46..fe243503 100644
