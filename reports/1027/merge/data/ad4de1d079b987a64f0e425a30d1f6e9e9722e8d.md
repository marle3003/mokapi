...
Received string:  "{  \"category\": \"Tech\",  \"name\": \"CelestialPath\",  \"price\": 782072.4,  \"subcategory\": \"dvm2HNb\",  \"url\": \"http://www.directcommunities.com/harness/enhance/streamline\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Tech",  "name": "CelestialPath",  "price": 782072.4,  "subcategory": "dvm2HNb",  "url": "http://www.directcommunities.com/harness/enhance/streamline"}"

```

```yaml
- text: "{ \"category\": \"Tech\", \"name\": \"CelestialPath\", \"price\": 782072.4, \"subcategory\": \"dvm2HNb\", \"url\": \"http://www.directcommunities.com/harness/enhance/streamline\" }"
```
