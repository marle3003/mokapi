...
Received string:  "{  \"category\": \"Drama\",  \"description\": \"What hug quickly understand the eye.\",  \"id\": \"1b210daa-bd47-4cf9-9384-e7a2c4ab72f5\",  \"keywords\": \"konlmh\",  \"name\": \"Zebra\",  \"price\": 235109.12,  \"url\": \"http://www.vicedeliver.biz/disintermediate/synergize/end-to-end/drive\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Drama",  "description": "What hug quickly understand the eye.",  "id": "1b210daa-bd47-4cf9-9384-e7a2c4ab72f5",  "keywords": "konlmh",  "name": "Zebra",  "price": 235109.12,  "url": "http://www.vicedeliver.biz/disintermediate/synergize/end-to-end/drive"}"

```

```yaml
- text: "{ \"category\": \"Drama\", \"description\": \"What hug quickly understand the eye.\", \"id\": \"1b210daa-bd47-4cf9-9384-e7a2c4ab72f5\", \"keywords\": \"konlmh\", \"name\": \"Zebra\", \"price\": 235109.12, \"url\": \"http://www.vicedeliver.biz/disintermediate/synergize/end-to-end/drive\" }"
```
