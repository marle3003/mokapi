...
Received string:  "{  \"description\": \"What fight Gaussian outside wolf ours nightly early join door she every they witty my none normally be hand poorly nightly phew before none.\",  \"id\": \"020b9dc3-1995-4873-9caa-d3d437c24f37\",  \"keywords\": \"aVoxXBTupZyRHls\",  \"name\": \"OasisDream\",  \"price\": 680619.06,  \"subcategory\": \"afKus4ml\",  \"url\": \"https://www.corporatee-tailers.biz/intuitive/applications\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "description": "What fight Gaussian outside wolf ours nightly early join door she every they witty my none normally be hand poorly nightly phew before none.",  "id": "020b9dc3-1995-4873-9caa-d3d437c24f37",  "keywords": "aVoxXBTupZyRHls",  "name": "OasisDream",  "price": 680619.06,  "subcategory": "afKus4ml",  "url": "https://www.corporatee-tailers.biz/intuitive/applications"}"

```

```yaml
- text: "{ \"description\": \"What fight Gaussian outside wolf ours nightly early join door she every they witty my none normally be hand poorly nightly phew before none.\", \"id\": \"020b9dc3-1995-4873-9caa-d3d437c24f37\", \"keywords\": \"aVoxXBTupZyRHls\", \"name\": \"OasisDream\", \"price\": 680619.06, \"subcategory\": \"afKus4ml\", \"url\": \"https://www.corporatee-tailers.biz/intuitive/applications\" }"
```
