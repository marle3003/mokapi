...
Received string:  "{  \"category\": \"Cooking\",  \"description\": \"Table up of flag her as several between exactly around now fuel improvised group ours what stack cry then consequently her but whose.\",  \"id\": \"74f4287e-3078-467d-9a50-a1874c96b0c3\",  \"keywords\": \"dmddrPk\",  \"name\": \"AlphaSphere\",  \"price\": 460620.24,  \"subcategory\": \"\",  \"url\": \"https://www.forwardfront-end.io/benchmark\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Cooking",  "description": "Table up of flag her as several between exactly around now fuel improvised group ours what stack cry then consequently her but whose.",  "id": "74f4287e-3078-467d-9a50-a1874c96b0c3",  "keywords": "dmddrPk",  "name": "AlphaSphere",  "price": 460620.24,  "subcategory": "",  "url": "https://www.forwardfront-end.io/benchmark"}"

```

```yaml
- text: "{ \"category\": \"Cooking\", \"description\": \"Table up of flag her as several between exactly around now fuel improvised group ours what stack cry then consequently her but whose.\", \"id\": \"74f4287e-3078-467d-9a50-a1874c96b0c3\", \"keywords\": \"dmddrPk\", \"name\": \"AlphaSphere\", \"price\": 460620.24, \"subcategory\": \"\", \"url\": \"https://www.forwardfront-end.io/benchmark\" }"
```
