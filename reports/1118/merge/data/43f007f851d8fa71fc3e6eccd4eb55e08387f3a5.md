...
Received string:  "{  \"description\": \"Mornings in Newark favor hand.\",  \"name\": \"TideHarbor\",  \"price\": 836639.43}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "description": "Mornings in Newark favor hand.",  "name": "TideHarbor",  "price": 836639.43}"

```

```yaml
- text: "{ \"description\": \"Mornings in Newark favor hand.\", \"name\": \"TideHarbor\", \"price\": 836639.43 }"
```
