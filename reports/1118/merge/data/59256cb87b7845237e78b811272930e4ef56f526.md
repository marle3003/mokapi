...
Received string:  "{  \"category\": \"Fitness\",  \"description\": \"Systematically improve the thing quarterly.\",  \"id\": \"11483245-ffa5-4029-9e0b-426625905674\",  \"keywords\": \"Us\",  \"name\": \"Prism\",  \"price\": 148922.85,  \"subcategory\": \"gMXiVSyg\",  \"url\": \"https://www.investorleading-edge.name/experiences/metrics/user-centric\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Fitness",  "description": "Systematically improve the thing quarterly.",  "id": "11483245-ffa5-4029-9e0b-426625905674",  "keywords": "Us",  "name": "Prism",  "price": 148922.85,  "subcategory": "gMXiVSyg",  "url": "https://www.investorleading-edge.name/experiences/metrics/user-centric"}"

```

```yaml
- text: "{ \"category\": \"Fitness\", \"description\": \"Systematically improve the thing quarterly.\", \"id\": \"11483245-ffa5-4029-9e0b-426625905674\", \"keywords\": \"Us\", \"name\": \"Prism\", \"price\": 148922.85, \"subcategory\": \"gMXiVSyg\", \"url\": \"https://www.investorleading-edge.name/experiences/metrics/user-centric\" }"
```
