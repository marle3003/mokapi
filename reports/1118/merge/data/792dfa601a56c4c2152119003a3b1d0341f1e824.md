...
Received string:  "{  \"category\": \"Tools\",  \"description\": \"Mind the thing, then celebrate!\",  \"id\": \"d436096f-9470-4e35-8cca-8c7199138d26\",  \"name\": \"Nova\",  \"price\": 621188.62,  \"subcategory\": \"Q03kpQqLCR5JXj\",  \"url\": \"https://www.staffseize.io/compelling\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Tools",  "description": "Mind the thing, then celebrate!",  "id": "d436096f-9470-4e35-8cca-8c7199138d26",  "name": "Nova",  "price": 621188.62,  "subcategory": "Q03kpQqLCR5JXj",  "url": "https://www.staffseize.io/compelling"}"

```

```yaml
- text: "{ \"category\": \"Tools\", \"description\": \"Mind the thing, then celebrate!\", \"id\": \"d436096f-9470-4e35-8cca-8c7199138d26\", \"name\": \"Nova\", \"price\": 621188.62, \"subcategory\": \"Q03kpQqLCR5JXj\", \"url\": \"https://www.staffseize.io/compelling\" }"
```
