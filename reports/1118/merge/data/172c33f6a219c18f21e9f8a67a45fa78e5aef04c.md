...
Received string:  "{  \"category\": \"Design\",  \"description\": \"Balance shock-resistant with place.\",  \"id\": \"e9cf3bb1-3762-4711-9f1a-5702a4ab8d04\",  \"name\": \"RippleZone\",  \"price\": 638339.84,  \"subcategory\": \":kBwKchBekaO\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Design",  "description": "Balance shock-resistant with place.",  "id": "e9cf3bb1-3762-4711-9f1a-5702a4ab8d04",  "name": "RippleZone",  "price": 638339.84,  "subcategory": ":kBwKchBekaO"}"

```

```yaml
- text: "{ \"category\": \"Design\", \"description\": \"Balance shock-resistant with place.\", \"id\": \"e9cf3bb1-3762-4711-9f1a-5702a4ab8d04\", \"name\": \"RippleZone\", \"price\": 638339.84, \"subcategory\": \":kBwKchBekaO\" }"
```
