...
Received string:  "{  \"category\": \"Data\",  \"description\": \"Budget latency for group.\",  \"id\": \"e3c79279-3640-4ca6-b4ac-393ff6a0d45d\",  \"keywords\": \"k6fcpIVvik2GdO\",  \"name\": \"BetaBridge\",  \"price\": 717862.44,  \"subcategory\": \"BMvsOfrfwGM\",  \"url\": \"http://www.deputybricks-and-clicks.net/models/global/portals\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Data",  "description": "Budget latency for group.",  "id": "e3c79279-3640-4ca6-b4ac-393ff6a0d45d",  "keywords": "k6fcpIVvik2GdO",  "name": "BetaBridge",  "price": 717862.44,  "subcategory": "BMvsOfrfwGM",  "url": "http://www.deputybricks-and-clicks.net/models/global/portals"}"

```

```yaml
- text: "{ \"category\": \"Data\", \"description\": \"Budget latency for group.\", \"id\": \"e3c79279-3640-4ca6-b4ac-393ff6a0d45d\", \"keywords\": \"k6fcpIVvik2GdO\", \"name\": \"BetaBridge\", \"price\": 717862.44, \"subcategory\": \"BMvsOfrfwGM\", \"url\": \"http://www.deputybricks-and-clicks.net/models/global/portals\" }"
```
