...
Received string:  "{  \"category\": \"Lifestyle\",  \"description\": \"Mornings in Columbus favor case.\",  \"id\": \"b14a62c1-5d0a-49bf-8b3e-6236920fd496\",  \"keywords\": \"UlxFE3Ao\",  \"price\": 805631.46,  \"subcategory\": \"D\",  \"url\": \"http://www.salesleverage.info/strategize/rich/iterate/world-class\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Lifestyle",  "description": "Mornings in Columbus favor case.",  "id": "b14a62c1-5d0a-49bf-8b3e-6236920fd496",  "keywords": "UlxFE3Ao",  "price": 805631.46,  "subcategory": "D",  "url": "http://www.salesleverage.info/strategize/rich/iterate/world-class"}"

```

```yaml
- text: "{ \"category\": \"Lifestyle\", \"description\": \"Mornings in Columbus favor case.\", \"id\": \"b14a62c1-5d0a-49bf-8b3e-6236920fd496\", \"keywords\": \"UlxFE3Ao\", \"price\": 805631.46, \"subcategory\": \"D\", \"url\": \"http://www.salesleverage.info/strategize/rich/iterate/world-class\" }"
```
