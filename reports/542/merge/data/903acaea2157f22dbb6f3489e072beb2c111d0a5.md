...
Received string:  "{  \"category\": \"Finance\",  \"id\": \"ac81c902-eed5-4af6-b3b2-6a02d1b9c190\",  \"name\": \"YieldYarn\"}"
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    9 × locator resolved to <div class="ace_content">…</div>
      - unexpected value "{  "category": "Finance",  "id": "ac81c902-eed5-4af6-b3b2-6a02d1b9c190",  "name": "YieldYarn"}"
      ...
      - tabpanel "| Value":
        - region "Schema":
          ...
          - dialog "Value Validator - mokapi.shop.products":
            ...
            - button "Close"
            - region "Source":
              - text: application/json · 5 lines · 98 B
              - button "Copy raw content": 
              - button "Download raw content": 
              - region "Content":
                - textbox "Cursor at row 5"
                - text: "{ \"category\": \"Finance\", \"id\": \"ac81c902-eed5-4af6-b3b2-6a02d1b9c190\", \"name\": \"YieldYarn\" }"
            - status
            - button "Example"
            - button "Validate"
```
...
index 2f996826..77961eb7 100644
...
index 940c1317..e3e57426 100644
