...
Received string:  "{  \"category\": \"Film\",  \"description\": \"Prefer predictable person over surprising number.\",  \"id\": \"3842e27f-c174-4c85-a8bb-1d8a28edec6b\",  \"name\": \"Utopia\",  \"price\": 621634.12,  \"subcategory\": \"oysW\",  \"url\": \"https://www.leadwireless.io/scale\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    13 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Film",  "description": "Prefer predictable person over surprising number.",  "id": "3842e27f-c174-4c85-a8bb-1d8a28edec6b",  "name": "Utopia",  "price": 621634.12,  "subcategory": "oysW",  "url": "https://www.leadwireless.io/scale"}"

```

```yaml
- text: "{ \"category\": \"Film\", \"description\": \"Prefer predictable person over surprising number.\", \"id\": \"3842e27f-c174-4c85-a8bb-1d8a28edec6b\", \"name\": \"Utopia\", \"price\": 621634.12, \"subcategory\": \"oysW\", \"url\": \"https://www.leadwireless.io/scale\" }"
```
