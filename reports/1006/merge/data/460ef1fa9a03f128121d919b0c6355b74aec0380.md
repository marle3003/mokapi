...
Received string:  "{  \"description\": \"Do quit ocean to without secondly none yesterday under off fruit out somebody regularly seldom besides ourselves neither safely no actor she our then.\",  \"id\": \"4ae31d78-7a86-4515-a054-86b7622ddf4c\",  \"keywords\": \"fsiaxpiwaxvYjF\",  \"name\": \"DewMeadow\",  \"subcategory\": \"Zby<4einaAe\",  \"url\": \"http://www.investorwhiteboard.org/dynamic/e-commerce/wireless\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "description": "Do quit ocean to without secondly none yesterday under off fruit out somebody regularly seldom besides ourselves neither safely no actor she our then.",  "id": "4ae31d78-7a86-4515-a054-86b7622ddf4c",  "keywords": "fsiaxpiwaxvYjF",  "name": "DewMeadow",  "subcategory": "Zby<4einaAe",  "url": "http://www.investorwhiteboard.org/dynamic/e-commerce/wireless"}"

```

```yaml
- text: "{ \"description\": \"Do quit ocean to without secondly none yesterday under off fruit out somebody regularly seldom besides ourselves neither safely no actor she our then.\", \"id\": \"4ae31d78-7a86-4515-a054-86b7622ddf4c\", \"keywords\": \"fsiaxpiwaxvYjF\", \"name\": \"DewMeadow\", \"subcategory\": \"Zby<4einaAe\", \"url\": \"http://www.investorwhiteboard.org/dynamic/e-commerce/wireless\" }"
```
