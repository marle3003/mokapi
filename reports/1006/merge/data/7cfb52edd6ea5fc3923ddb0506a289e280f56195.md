...
Received string:  "{  \"category\": \"Travel\",  \"description\": \"Of those how after petrify wash theirs aha itself it myself wash listen so what laugh Belgian will fly grieving that anyway am please each till.\",  \"keywords\": \"zE\",  \"subcategory\": \"ODjJDbFAh2\",  \"url\": \"http://www.leadarchitectures.name/infomediaries/proactive\"}"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('dialog', { name: 'Value Validator - mokapi.shop.products' }).getByRole('region', { name: 'Source' }).getByRole('region', { name: 'content' }).locator('.ace_content')
    14 × locator resolved to <div class="ace_content">…</div>
       - unexpected value "{  "category": "Travel",  "description": "Of those how after petrify wash theirs aha itself it myself wash listen so what laugh Belgian will fly grieving that anyway am please each till.",  "keywords": "zE",  "subcategory": "ODjJDbFAh2",  "url": "http://www.leadarchitectures.name/infomediaries/proactive"}"

```

```yaml
- text: "{ \"category\": \"Travel\", \"description\": \"Of those how after petrify wash theirs aha itself it myself wash listen so what laugh Belgian will fly grieving that anyway am please each till.\", \"keywords\": \"zE\", \"subcategory\": \"ODjJDbFAh2\", \"url\": \"http://www.leadarchitectures.name/infomediaries/proactive\" }"
```
